#!/usr/bin/env python3
"""Script to create Verschenken & Tauschen subcategory pages"""

subcategories = [
    {'name': 'Tauschen', 'filename': 'TauschenPage.js', 'route': 'tauschen', 'icon': '''<path d="M22 28 L28 22 L28 26 L36 26 L36 22 L42 28 L36 34 L36 30 L28 30 L28 34 Z" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><path d="M22 28 L28 22 L28 26 L36 26 L36 22 L42 28 L36 34 L36 30 L28 30 L28 34 Z" strokeWidth="2.5" strokeLinejoin="round"/>''', 'description': 'Tauschen'},
    {'name': 'Verleihen', 'filename': 'VerleihenPage.js', 'route': 'verleihen', 'icon': '''<circle cx="32" cy="28" r="8" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="32" cy="28" r="8" strokeWidth="2.5"/><path d="M26 38 L26 44 M32 38 L32 44 M38 38 L38 44" strokeWidth="2.5" strokeLinecap="round"/>''', 'description': 'Verleihen'},
    {'name': 'Verschenken', 'filename': 'VerschenkenPage.js', 'route': 'verschenken', 'icon': '''<rect x="24" y="26" width="16" height="12" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/><rect x="24" y="26" width="16" height="12" strokeWidth="2.5" rx="2"/><path d="M28 22 L28 26 M36 22 L36 26" strokeWidth="2.5" strokeLinecap="round"/><path d="M24 30 L40 30" strokeWidth="2" strokeLinecap="round"/>''', 'description': 'Verschenken'}
]
...
function {component_name}() {{
    ...
    const filteredListings = listings.filter(listing => listing.category === 'Verschenken & Tauschen' && listing.subCategory === '{subcategory_name}');
...
print(f"\n✅ Created {len(subcategories)} Verschenken & Tauschen subcategory pages!")
