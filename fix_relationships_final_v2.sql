-- FINAL FIX V2 (Corrected Syntax)
-- Run this to fix missing tables, connections, and gallery visibility.
...
-- 4. FIX GALLERY (Force Data) - Corrected Syntax
-- Use subquery for Limit/Order which was causing the error
UPDATE listings 
