#!/usr/bin/env python3
"""
Update all Mode & Beauty subcategory pages to include standardized three-level navigation
"""
...
subcategories = [
    ('BeautyGesundheitPage.js', 'Beauty & Gesundheit', '/Mode-Beauty/Beauty-Gesundheit'),
    ('DamenbekleidungPage.js', 'Damenbekleidung', '/Mode-Beauty/Damenbekleidung'),
    ('DamenschuhePage.js', 'Damenschuhe', '/Mode-Beauty/Damenschuhe'),
    ('HerrenbekleidungPage.js', 'Herrenbekleidung', '/Mode-Beauty/Herrenbekleidung'),
    ('HerrenschuhePage.js', 'Herrenschuhe', '/Mode-Beauty/Herrenschuhe'),
    ('TaschenAccessoiresPage.js', 'Taschen & Accessoires', '/Mode-Beauty/Taschen-Accessoires'),
    ('UhrenSchmuckPage.js', 'Uhren & Schmuck', '/Mode-Beauty/Uhren-Schmuck'),
    ('WeiteresModeBeautyPage.js', 'Weiteres Mode & Beauty', '/Mode-Beauty/Weiteres-Mode-Beauty'),
]
...
print(f"\n🎉 Successfully updated all {len(subcategories)} Mode & Beauty subcategory pages!")
