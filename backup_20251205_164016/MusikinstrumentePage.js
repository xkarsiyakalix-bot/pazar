...
function MusikinstrumentePage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Musik, Filme & Bücher' && listing.subCategory === 'Musikinstrumente' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 159347 }, { value: 'Nur Abholung', count: 94546 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 22781 },
                            { value: 'Sehr Gut', count: 120928 },
                            { value: 'Gut', count: 63766 },
                            { value: 'In Ordnung', count: 13592 },
                            { value: 'Defekt', count: 2613 }
                        ].map(z => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 251672 }, { value: 'Gesuche', count: 2426 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 235624 }, { value: 'Gewerblich', count: 18474 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(48.042)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 118253 }, { value: 'Hermes', count: 95977 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 34100 }, { value: 'Bayern', count: 43932 }, { value: 'Berlin', count: 16150 },
                            { value: 'Brandenburg', count: 4774 }, { value: 'Bremen', count: 1923 }, { value: 'Hamburg', count: 7403 },
                            { value: 'Hessen', count: 19595 }, { value: 'Mecklenburg-Vorpommern', count: 2517 }, { value: 'Niedersachsen', count: 24969 },
                            { value: 'Nordrhein-Westfalen', count: 56906 }, { value: 'Rheinland-Pfalz', count: 12717 }, { value: 'Saarland', count: 3441 },
                            { value: 'Sachsen', count: 9004 }, { value: 'Sachsen-Anhalt', count: 3377 }, { value: 'Schleswig-Holstein', count: 9224 },
                            { value: 'Thüringen', count: 4066 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <path d="M28 20 L28 44 M36 20 L36 44" strokeWidth="2.5" />
                                <path d="M20 28 L44 28 M20 36 L44 36" strokeWidth="2.5" />
                                <circle cx="32" cy="32" r="14" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <circle cx="32" cy="32" r="14" strokeWidth="2.5" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Musikinstrumente</h1><p className="text-white text-lg opacity-90">Musikinstrumente</p></div>
                    </div>
