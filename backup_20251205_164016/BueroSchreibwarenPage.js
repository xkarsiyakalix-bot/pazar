...
function BueroSchreibwarenPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Musik, Filme & Bücher' && listing.subCategory === 'Büro & Schreibwaren' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 49959 }, { value: 'Nur Abholung', count: 7067 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 27807 },
                            { value: 'Sehr Gut', count: 15095 },
                            { value: 'Gut', count: 6019 },
                            { value: 'In Ordnung', count: 951 }
                        ].map(z => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 57135 }, { value: 'Gesuche', count: 147 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 55660 }, { value: 'Gewerblich', count: 1622 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(15.208)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 31642 }, { value: 'Hermes', count: 30522 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 7237 }, { value: 'Bayern', count: 10431 }, { value: 'Berlin', count: 2681 },
                            { value: 'Brandenburg', count: 1466 }, { value: 'Bremen', count: 445 }, { value: 'Hamburg', count: 1859 },
                            { value: 'Hessen', count: 5409 }, { value: 'Mecklenburg-Vorpommern', count: 595 }, { value: 'Niedersachsen', count: 5564 },
                            { value: 'Nordrhein-Westfalen', count: 12142 }, { value: 'Rheinland-Pfalz', count: 2527 }, { value: 'Saarland', count: 572 },
                            { value: 'Sachsen', count: 2354 }, { value: 'Sachsen-Anhalt', count: 759 }, { value: 'Schleswig-Holstein', count: 2222 },
                            { value: 'Thüringen', count: 1019 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="20" y="18" width="24" height="28" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                                <rect x="20" y="18" width="24" height="28" strokeWidth="2.5" rx="2" />
                                <path d="M26 26 L38 26 M26 32 L38 32 M26 38 L34 38" strokeWidth="2" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Büro & Schreibwaren</h1><p className="text-white text-lg opacity-90">Büro & Schreibwaren</p></div>
                    </div>
