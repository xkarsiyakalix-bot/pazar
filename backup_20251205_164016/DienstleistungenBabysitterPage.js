...
function DienstleistungenBabysitterPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Altenpflege' &&
                ...
                <div className="flex gap-6">
                    <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(4.241)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(1.169)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(3.393)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(2.017)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                {[
                                    { value: 'Baden-Württemberg', count: 689 },
                                    { value: 'Bayern', count: 692 },
                                    { value: 'Berlin', count: 228 },
                                    { value: 'Brandenburg', count: 117 },
                                    { value: 'Bremen', count: 37 },
                                    { value: 'Hamburg', count: 142 },
                                    { value: 'Hessen', count: 399 },
                                    { value: 'Mecklenburg-Vorpommern', count: 78 },
                                    { value: 'Niedersachsen', count: 798 },
                                    { value: 'Nordrhein-Westfalen', count: 1333 },
                                    { value: 'Rheinland-Pfalz', count: 216 },
                                    { value: 'Saarland', count: 50 },
                                    { value: 'Sachsen', count: 139 },
                                    { value: 'Sachsen-Anhalt', count: 48 },
                                    { value: 'Schleswig-Holstein', count: 374 },
                                    { value: 'Thüringen', count: 70 }
                                ].map(state => (
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 className="text-4xl font-bold text-white mb-1">Babysitter/-in & Kinderbetreuung</h1>
                                            <p className="text-white text-lg opacity-90">Babysitter & Kinderbetreuung Dienstleistungen</p>
                                        </div>
                                    </div>
