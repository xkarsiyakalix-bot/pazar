...
function WeiteresFreizeitHobbyNachbarschaftPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Weiteres Freizeit, Hobby & Nachbarschaft' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <div className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                            <span>Weiteres Freizeit, Hobby & Nachbarschaft</span>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 129050 }, { value: 'Nur Abholung', count: 50755 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 178079 }, { value: 'Gesuche', count: 3110 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 173174 }, { value: 'Gewerblich', count: 8015 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 86279 }, { value: 'Hermes', count: 80577 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 22190 }, { value: 'Bayern', count: 30920 }, { value: 'Berlin', count: 6347 },
                            { value: 'Brandenburg', count: 5447 }, { value: 'Bremen', count: 1086 }, { value: 'Hamburg', count: 3847 },
                            { value: 'Hessen', count: 13294 }, { value: 'Mecklenburg-Vorpommern', count: 3004 }, { value: 'Niedersachsen', count: 20537 },
                            { value: 'Nordrhein-Westfalen', count: 36509 }, { value: 'Rheinland-Pfalz', count: 9390 }, { value: 'Saarland', count: 2233 },
                            { value: 'Sachsen', count: 9846 }, { value: 'Sachsen-Anhalt', count: 4222 }, { value: 'Schleswig-Holstein', count: 8183 },
                            { value: 'Thüringen', count: 4134 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="20" y="20" width="24" height="24" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                                <rect x="20" y="20" width="24" height="24" strokeWidth="2.5" rx="2" />
                                <path d="M28 28 L36 28 M28 32 L36 32 M28 36 L36 36" strokeWidth="2" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Weiteres Freizeit, Hobby & Nachbarschaft</h1><p className="text-white text-lg opacity-90">Weiteres Freizeit, Hobby & Nachbarschaft</p></div>
                    </div>
...
export default WeiteresFreizeitHobbyNachbarschaftPage;
