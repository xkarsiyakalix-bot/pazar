...
function HeimwerkenPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Heimwerken' &&
        ...
        <div className="min-h-screen bg-gray-50"><div className="max-w-[1400px] mx-auto px-4 py-6"><div className="flex gap-6">
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Versand</h4><div className="space-y-2">
                    {[{ value: 'Versand möglich', label: 'Versand möglich', count: '772.369' }, { value: 'Nur Abholung', label: 'Nur Abholung', count: '433.334' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Zustand</h4><div className="space-y-2">
                    {[{ value: 'Neu', label: 'Neu', count: '429.058' }, { value: 'Sehr Gut', label: 'Sehr Gut', count: '234.874' }, { value: 'Gut', label: 'Gut', count: '234.959' }, { value: 'In Ordnung', label: 'In Ordnung', count: '69.847' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Angebotstyp</h4><div className="space-y-2">
                    {[{ value: 'Angebote', label: 'Angebote', count: '1.201.042' }, { value: 'Gesuche', label: 'Gesuche', count: '7.942' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Anbieter</h4><div className="space-y-2">
                    {[{ value: 'Privat', label: 'Privat', count: '1.035.833' }, { value: 'Gewerblich', label: 'Gewerblich', count: '173.151' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Paketdienst</h4><div className="space-y-2">
                    {[{ value: 'DHL', label: 'DHL', count: '469.744' }, { value: 'Hermes', label: 'Hermes', count: '464.371' }].map(option => (
                ...
                <div className="mb-6"><h4 className="font-bold text-gray-900 mb-3 text-base">Ort</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Baden-Württemberg', label: 'Baden-Württemberg', count: '151.656' }, { value: 'Bayern', label: 'Bayern', count: '202.345' }, { value: 'Berlin', label: 'Berlin', count: '32.632' }, { value: 'Brandenburg', label: 'Brandenburg', count: '42.183' }, { value: 'Bremen', label: 'Bremen', count: '6.966' }, { value: 'Hamburg', label: 'Hamburg', count: '16.174' }, { value: 'Hessen', label: 'Hessen', count: '87.186' }, { value: 'Mecklenburg-Vorpommern', label: 'Mecklenburg-Vorpommern', count: '20.807' }, { value: 'Niedersachsen', label: 'Niedersachsen', count: '130.394' }, { value: 'Nordrhein-Westfalen', label: 'Nordrhein-Westfalen', count: '261.237' }, { value: 'Rheinland-Pfalz', label: 'Rheinland-Pfalz', count: '66.197' }, { value: 'Saarland', label: 'Saarland', count: '15.502' }, { value: 'Sachsen', label: 'Sachsen', count: '67.009' }, { value: 'Sachsen-Anhalt', label: 'Sachsen-Anhalt', count: '32.841' }, { value: 'Schleswig-Holstein', label: 'Schleswig-Holstein', count: '43.574' }, { value: 'Thüringen', label: 'Thüringen', count: '32.281' }].map(option => (
            ...
            <div className="flex-1">
                <div className="bg-red-600 rounded-2xl shadow-xl p-8 mb-6 relative overflow-hidden"><div className="absolute inset-0 opacity-10"><div className="absolute top-0 left-0 w-full h-full" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(255,255,255,.1) 35px, rgba(255,255,255,.1) 70px)' }}></div></div>
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Heimwerken</h1><p className="text-white text-lg opacity-90">Werkzeug und Material</p></div>
                    </div>
