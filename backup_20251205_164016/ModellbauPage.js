...
function ModellbauPage() {
    ...
    const resetFilters = () => {
        setPriceFrom(''); setPriceTo(''); setVersand(''); setZustand(''); setOfferType('');
        setProviderType(''); setDirektKaufen(''); setPaketdienst(''); setSelectedState('');
    };

    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Modellbau' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 428490 }, { value: 'Nur Abholung', count: 46606 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 101177 },
                            { value: 'Sehr Gut', count: 159056 },
                            { value: 'Gut', count: 83218 },
                            { value: 'In Ordnung', count: 23063 },
                            { value: 'Defekt', count: 5674 }
                        ].map(z => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 473004 }, { value: 'Gesuche', count: 3554 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 467384 }, { value: 'Gewerblich', count: 9174 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(103.845)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 296921 }, { value: 'Hermes', count: 243514 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 64067 }, { value: 'Bayern', count: 79557 }, { value: 'Berlin', count: 14890 },
                            { value: 'Brandenburg', count: 11126 }, { value: 'Bremen', count: 2400 }, { value: 'Hamburg', count: 9322 },
                            { value: 'Hessen', count: 35257 }, { value: 'Mecklenburg-Vorpommern', count: 5131 }, { value: 'Niedersachsen', count: 52889 },
                            { value: 'Nordrhein-Westfalen', count: 111827 }, { value: 'Rheinland-Pfalz', count: 24361 }, { value: 'Saarland', count: 5054 },
                            { value: 'Sachsen', count: 22854 }, { value: 'Sachsen-Anhalt', count: 7728 }, { value: 'Schleswig-Holstein', count: 21620 },
                            { value: 'Thüringen', count: 8475 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="20" y="24" width="24" height="16" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                                <rect x="20" y="24" width="24" height="16" strokeWidth="2.5" rx="2" />
                                <circle cx="26" cy="40" r="3" strokeWidth="2.5" />
                                <circle cx="38" cy="40" r="3" strokeWidth="2.5" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Modellbau</h1><p className="text-white text-lg opacity-90">Modellbau</p></div>
                    </div>
