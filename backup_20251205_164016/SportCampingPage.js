...
function SportCampingPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Sport & Camping' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Ballsport', count: 136826 },
                            { value: 'Camping & Outdoor', count: 185414 },
                            { value: 'Fitness', count: 235419 },
                            { value: 'Radsport', count: 54979 },
                            { value: 'Tanzen & Laufen', count: 12220 },
                            { value: 'Wassersport', count: 134282 },
                            { value: 'Wintersport', count: 254001 },
                            { value: 'Weiteres Sport & Camping', count: 86135 }
                        ].map(art => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 752811 }, { value: 'Nur Abholung', count: 344532 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 205074 },
                            { value: 'Sehr Gut', count: 450377 },
                            { value: 'Gut', count: 265222 },
                            { value: 'In Ordnung', count: 58651 },
                            { value: 'Defekt', count: 3688 }
                        ].map(z => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 1093941 }, { value: 'Gesuche', count: 5617 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 1051685 }, { value: 'Gewerblich', count: 47873 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(257.957)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 566728 }, { value: 'Hermes', count: 515698 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 153547 }, { value: 'Bayern', count: 242039 }, { value: 'Berlin', count: 39067 },
                            { value: 'Brandenburg', count: 26881 }, { value: 'Bremen', count: 6381 }, { value: 'Hamburg', count: 26741 },
                            { value: 'Hessen', count: 79776 }, { value: 'Mecklenburg-Vorpommern', count: 15255 }, { value: 'Niedersachsen', count: 102768 },
                            { value: 'Nordrhein-Westfalen', count: 212298 }, { value: 'Rheinland-Pfalz', count: 47724 }, { value: 'Saarland', count: 12202 },
                            { value: 'Sachsen', count: 55201 }, { value: 'Sachsen-Anhalt', count: 17149 }, { value: 'Schleswig-Holstein', count: 43798 },
                            { value: 'Thüringen', count: 18731 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                ...
                                <path d="M32 20 L32 26 M32 38 L32 44 M20 32 L26 32 M38 32 L44 32" strokeWidth="2.5" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Sport & Camping</h1><p className="text-white text-lg opacity-90">Sport & Camping</p></div>
                    </div>
