...
function BadezimmerPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Badezimmer' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Versand möglich', label: 'Versand möglich', count: '118.005' },
                            { value: 'Nur Abholung', label: 'Nur Abholung', count: '94.413' }
                        ].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Beige', label: 'Beige', count: '4.984' },
                            { value: 'Blau', label: 'Blau', count: '4.093' },
                            { value: 'Braun', label: 'Braun', count: '5.769' },
                            { value: 'Bunt', label: 'Bunt', count: '1.333' },
                            { value: 'Burgunderrot', label: 'Burgunderrot', count: '115' },
                            { value: 'Gelb', label: 'Gelb', count: '645' },
                            { value: 'Gold', label: 'Gold', count: '1.241' },
                            { value: 'Grau', label: 'Grau', count: '10.467' },
                            { value: 'Grün', label: 'Grün', count: '2.082' },
                            { value: 'Holz', label: 'Holz', count: '4.624' },
                            { value: 'Khaki', label: 'Khaki', count: '48' },
                            { value: 'Lila', label: 'Lila', count: '431' },
                            { value: 'Orange', label: 'Orange', count: '441' },
                            { value: 'Rosa', label: 'Rosa', count: '932' },
                            { value: 'Rot', label: 'Rot', count: '1.087' },
                            { value: 'Schwarz', label: 'Schwarz', count: '12.198' },
                            { value: 'Silber', label: 'Silber', count: '27.308' },
                            { value: 'Transparent', label: 'Transparent', count: '3.866' },
                            { value: 'Weiß', label: 'Weiß', count: '57.267' },
                            { value: 'Andere Farben', label: 'Andere Farben', count: '19.695' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                {/* Material Filter */}
                <div className="mb-6 pb-6 border-b border-gray-200">
                    <h4 className="font-bold text-gray-900 mb-3 text-base">Material</h4>
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Bronze', label: 'Bronze', count: '233' },
                            { value: 'Eiche', label: 'Eiche', count: '683' },
                            { value: 'Eisen', label: 'Eisen', count: '1.569' },
                            { value: 'Glas', label: 'Glas', count: '12.201' },
                            { value: 'Holz', label: 'Holz', count: '18.644' },
                            { value: 'Keramik', label: 'Keramik', count: '14.711' },
                            { value: 'Kiefer', label: 'Kiefer', count: '96' },
                            { value: 'Korb & Rattan', label: 'Korb & Rattan', count: '895' },
                            { value: 'Kunststoff', label: 'Kunststoff', count: '19.084' },
                            { value: 'Lackiert', label: 'Lackiert', count: '777' },
                            { value: 'Leder', label: 'Leder', count: '73' },
                            { value: 'Marmor', label: 'Marmor', count: '473' },
                            { value: 'Massivholz', label: 'Massivholz', count: '486' },
                            { value: 'Metall', label: 'Metall', count: '22.371' },
                            { value: 'Samt', label: 'Samt', count: '37' },
                            { value: 'Schichtstoff', label: 'Schichtstoff', count: '458' },
                            { value: 'Stahl', label: 'Stahl', count: '3.960' },
                            { value: 'Stein', label: 'Stein', count: '761' },
                            { value: 'Stoff', label: 'Stoff', count: '2.685' },
                            { value: 'Sonstige', label: 'Sonstige', count: '26.071' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                                    <input type="checkbox" checked={selectedMaterial.includes(option.value)} onChange={() => toggleFilter(option.value, selectedMaterial, setSelectedMaterial)} className="w-4 h-4 text-red-600 border-gray-300 rounded focus:ring-red-500" />
                                    <span className="ml-2 text-sm text-gray-700 group-hover:text-gray-900">{option.label}</span>
                                </div>
                                <span className="text-xs text-gray-500">({option.count})</span>
                            </label>
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', label: 'Neu', count: '79.981' },
                            { value: 'Sehr Gut', label: 'Sehr Gut', count: '65.755' },
                            { value: 'Gut', label: 'Gut', count: '32.429' },
                            { value: 'In Ordnung', label: 'In Ordnung', count: '5.824' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Angebote', label: 'Angebote', count: '212.273' },
                            { value: 'Gesuche', label: 'Gesuche', count: '618' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Privat', label: 'Privat', count: '201.200' },
                            { value: 'Gewerblich', label: 'Gewerblich', count: '11.691' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <label className="flex items-center justify-between cursor-pointer group">
                        ...
                        <span className="text-xs text-gray-500">(39.245)</span>
                    </label>
                </div>
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'DHL', label: 'DHL', count: '88.632' },
                            { value: 'Hermes', label: 'Hermes', count: '84.964' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', label: 'Baden-Württemberg', count: '25.754' },
                            { value: 'Bayern', label: 'Bayern', count: '35.074' },
                            { value: 'Berlin', label: 'Berlin', count: '9.149' },
                            { value: 'Brandenburg', label: 'Brandenburg', count: '5.884' },
                            { value: 'Bremen', label: 'Bremen', count: '1.538' },
                            { value: 'Hamburg', label: 'Hamburg', count: '5.201' },
                            { value: 'Hessen', label: 'Hessen', count: '16.780' },
                            { value: 'Mecklenburg-Vorpommern', label: 'Mecklenburg-Vorpommern', count: '3.393' },
                            { value: 'Niedersachsen', label: 'Niedersachsen', count: '23.365' },
                            { value: 'Nordrhein-Westfalen', label: 'Nordrhein-Westfalen', count: '46.572' },
                            { value: 'Rheinland-Pfalz', label: 'Rheinland-Pfalz', count: '10.114' },
                            { value: 'Saarland', label: 'Saarland', count: '2.431' },
                            { value: 'Sachsen', label: 'Sachsen', count: '10.176' },
                            { value: 'Sachsen-Anhalt', label: 'Sachsen-Anhalt', count: '4.547' },
                            { value: 'Schleswig-Holstein', label: 'Schleswig-Holstein', count: '8.246' },
                            { value: 'Thüringen', label: 'Thüringen', count: '4.667' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
            ...
            <div className="flex-1">
                <div className="bg-red-600 rounded-2xl shadow-xl p-8 mb-6 relative overflow-hidden"><div className="absolute inset-0 opacity-10"><div className="absolute top-0 left-0 w-full h-full" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(255,255,255,.1) 35px, rgba(255,255,255,.1) 70px)' }}></div></div>
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Badezimmer</h1><p className="text-white text-lg opacity-90">Badmöbel und Badausstattung</p></div>
                    </div>
