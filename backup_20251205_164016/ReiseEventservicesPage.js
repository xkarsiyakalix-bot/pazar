...
function ReiseEventservicesPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Reise & Eventservices' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 37667 }, { value: 'Gesuche', count: 569 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 14875 }, { value: 'Gewerblich', count: 23361 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 3581 }, { value: 'Bayern', count: 5187 }, { value: 'Berlin', count: 1421 },
                            { value: 'Brandenburg', count: 1057 }, { value: 'Bremen', count: 254 }, { value: 'Hamburg', count: 912 },
                            { value: 'Hessen', count: 2541 }, { value: 'Mecklenburg-Vorpommern', count: 734 }, { value: 'Niedersachsen', count: 5012 },
                            { value: 'Nordrhein-Westfalen', count: 10332 }, { value: 'Rheinland-Pfalz', count: 1611 }, { value: 'Saarland', count: 523 },
                            { value: 'Sachsen', count: 1566 }, { value: 'Sachsen-Anhalt', count: 670 }, { value: 'Schleswig-Holstein', count: 1731 },
                            { value: 'Thüringen', count: 1104 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <path d="M20 32 L32 20 L44 32 L32 44 Z" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <path d="M20 32 L32 20 L44 32 L32 44 Z" strokeWidth="2.5" />
                                <circle cx="32" cy="32" r="4" strokeWidth="2.5" fill="currentColor" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Reise & Eventservices</h1><p className="text-white text-lg opacity-90">Reise & Eventservices</p></div>
                    </div>
