...
function VertriebEinkaufVerkaufPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Jobs' && listing.subCategory === 'Vertrieb, Einkauf & Verkauf' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <div className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                            <span>Vertrieb, Einkauf & Verkauf</span>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Buchhalter/-in', count: 61 },
                            { value: 'Immobilienmakler/-in', count: 227 },
                            { value: 'Kaufmann/-frau', count: 2136 },
                            { value: 'Verkäufer/-in', count: 32380 },
                            { value: 'Weitere Berufe', count: 8347 }
                        ].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Vollzeit', count: 11857 }, { value: 'Teilzeit', count: 11585 }].map(time => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 41415 }, { value: 'Gesuche', count: 1737 }].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 1736 }, { value: 'Gewerblich', count: 41416 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 5116 }, { value: 'Bayern', count: 6542 }, { value: 'Berlin', count: 1690 },
                            { value: 'Brandenburg', count: 1378 }, { value: 'Bremen', count: 483 }, { value: 'Hamburg', count: 1230 },
                            { value: 'Hessen', count: 3340 }, { value: 'Mecklenburg-Vorpommern', count: 1161 }, { value: 'Niedersachsen', count: 5615 },
                            { value: 'Nordrhein-Westfalen', count: 8427 }, { value: 'Rheinland-Pfalz', count: 1776 }, { value: 'Saarland', count: 330 },
                            { value: 'Sachsen', count: 1551 }, { value: 'Sachsen-Anhalt', count: 939 }, { value: 'Schleswig-Holstein', count: 2603 },
                            { value: 'Thüringen', count: 971 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                ...
                                <path d="M26 24 L38 24 M26 30 L38 30 M26 36 L38 36" strokeWidth="2" strokeLinecap="round" />
                                <circle cx="32" cy="42" r="2" fill="currentColor" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Vertrieb, Einkauf & Verkauf</h1><p className="text-white text-lg opacity-90">Vertrieb, Einkauf & Verkauf</p></div>
                    </div>
