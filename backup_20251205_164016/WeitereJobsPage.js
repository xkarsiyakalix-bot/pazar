...
function WeitereJobsPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Jobs' && listing.subCategory === 'Weitere Jobs' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Designer/-in & Grafiker/-in', count: 619 },
                            { value: 'Friseur/-in', count: 1122 },
                            { value: 'Haushaltshilfe', count: 3475 },
                            { value: 'Hausmeister/-in', count: 2030 },
                            { value: 'Reinigungskraft', count: 23309 },
                            { value: 'Weitere Berufe', count: 121761 }
                        ].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Vollzeit', count: 36524 }, { value: 'Teilzeit', count: 15878 }].map(time => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 131585 }, { value: 'Gesuche', count: 20861 }].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 20870 }, { value: 'Gewerblich', count: 131576 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 15809 }, { value: 'Bayern', count: 18907 }, { value: 'Berlin', count: 8383 },
                            { value: 'Brandenburg', count: 4284 }, { value: 'Bremen', count: 1845 }, { value: 'Hamburg', count: 5259 },
                            { value: 'Hessen', count: 10230 }, { value: 'Mecklenburg-Vorpommern', count: 3305 }, { value: 'Niedersachsen', count: 19186 },
                            { value: 'Nordrhein-Westfalen', count: 37805 }, { value: 'Rheinland-Pfalz', count: 5570 }, { value: 'Saarland', count: 1437 },
                            { value: 'Sachsen', count: 7106 }, { value: 'Sachsen-Anhalt', count: 4016 }, { value: 'Schleswig-Holstein', count: 5863 },
                            { value: 'Thüringen', count: 3441 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                ...
                                <path d="M32 24 L32 32 L38 32" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Weitere Jobs</h1><p className="text-white text-lg opacity-90">Weitere Jobs</p></div>
                    </div>
