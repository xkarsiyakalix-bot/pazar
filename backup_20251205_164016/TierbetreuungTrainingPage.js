...
function TierbetreuungTrainingPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Tierbetreuung & Training' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">                <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                <div className="space-y-2 mt-3">
                    ...
                    <button className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                        <span>Tierbetreuung & Training</span>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Angebote', count: 5901 },
                            { value: 'Gesuche', count: 2434 }
                        ].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Privat', count: 5794 },
                            { value: 'Gewerblich', count: 2541 }
                        ].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 977 },
                            { value: 'Bayern', count: 1471 },
                            { value: 'Berlin', count: 196 },
                            { value: 'Brandenburg', count: 310 },
                            { value: 'Bremen', count: 47 },
                            { value: 'Hamburg', count: 171 },
                            { value: 'Hessen', count: 642 },
                            { value: 'Mecklenburg-Vorpommern', count: 194 },
                            { value: 'Niedersachsen', count: 1162 },
                            { value: 'Nordrhein-Westfalen', count: 1569 },
                            { value: 'Rheinland-Pfalz', count: 399 },
                            { value: 'Saarland', count: 66 },
                            { value: 'Sachsen', count: 299 },
                            { value: 'Sachsen-Anhalt', count: 148 },
                            { value: 'Schleswig-Holstein', count: 552 },
                            { value: 'Thüringen', count: 132 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <circle cx="26" cy="28" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Tierbetreuung & Training</h1><p className="text-white text-lg opacity-90">Tierbetreuung & Training</p></div>
                    </div>
