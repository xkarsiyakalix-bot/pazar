...
function KleintierePage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Kleintiere' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">                <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Hamster', count: 1484 },
                            { value: 'Hasen & Kaninchen', count: 12793 },
                            { value: 'Mäuse & Ratten', count: 663 },
                            { value: 'Meerschweinchen', count: 3209 },
                            { value: 'Weitere Kleintiere', count: 5945 }
                        ].map(animal => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Angebote', count: 24007 },
                            { value: 'Gesuche', count: 94 }
                        ].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Privat', count: 23261 },
                            { value: 'Gewerblich', count: 840 }
                        ].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 2684 },
                            { value: 'Bayern', count: 3976 },
                            { value: 'Berlin', count: 236 },
                            { value: 'Brandenburg', count: 897 },
                            { value: 'Bremen', count: 106 },
                            { value: 'Hamburg', count: 211 },
                            { value: 'Hessen', count: 1800 },
                            { value: 'Mecklenburg-Vorpommern', count: 750 },
                            { value: 'Niedersachsen', count: 2776 },
                            { value: 'Nordrhein-Westfalen', count: 4073 },
                            { value: 'Rheinland-Pfalz', count: 1229 },
                            { value: 'Saarland', count: 338 },
                            { value: 'Sachsen', count: 2031 },
                            { value: 'Sachsen-Anhalt', count: 1090 },
                            { value: 'Schleswig-Holstein', count: 734 },
                            { value: 'Thüringen', count: 1170 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <circle cx="30" cy="30" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Kleintiere</h1><p className="text-white text-lg opacity-90">Kleintiere & Nager</p></div>
                    </div>
