        ...
        <div className="min-h-screen bg-gray-50"><div className="max-w-[1400px] mx-auto px-4 py-6"><div className="flex gap-6">
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Versand</h4><div className="space-y-2">
                    {[{ value: 'Versand möglich', label: 'Versand möglich', count: '114.139' }, { value: 'Nur Abholung', label: 'Nur Abholung', count: '144.722' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Angebotstyp</h4><div className="space-y-2">
                    {[{ value: 'Angebote', label: 'Angebote', count: '258.615' }, { value: 'Gesuche', label: 'Gesuche', count: '734' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Anbieter</h4><div className="space-y-2">
                    {[{ value: 'Privat', label: 'Privat', count: '233.325' }, { value: 'Gewerblich', label: 'Gewerblich', count: '26.024' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Farbe</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Beige', label: 'Beige', count: '7.092' }, { value: 'Blau', label: 'Blau', count: '7.857' }, { value: 'Braun', label: 'Braun', count: '16.371' }, { value: 'Bunt', label: 'Bunt', count: '2.449' }, { value: 'Burgunderrot', label: 'Burgunderrot', count: '316' }, { value: 'Gelb', label: 'Gelb', count: '970' }, { value: 'Gold', label: 'Gold', count: '524' }, { value: 'Grau', label: 'Grau', count: '21.325' }, { value: 'Grün', label: 'Grün', count: '3.286' }, { value: 'Holz', label: 'Holz', count: '15.336' }, { value: 'Khaki', label: 'Khaki', count: '71' }, { value: 'Lila', label: 'Lila', count: '553' }, { value: 'Orange', label: 'Orange', count: '971' }, { value: 'Rosa', label: 'Rosa', count: '1.522' }, { value: 'Rot', label: 'Rot', count: '3.715' }, { value: 'Schwarz', label: 'Schwarz', count: '47.352' }, { value: 'Silber', label: 'Silber', count: '6.409' }, { value: 'Transparent', label: 'Transparent', count: '3.245' }, { value: 'Weiß', label: 'Weiß', count: '40.841' }, { value: 'Andere Farben', label: 'Andere Farben', count: '16.742' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Material</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Bronze', label: 'Bronze', count: '57' }, { value: 'Eiche', label: 'Eiche', count: '1.946' }, { value: 'Eisen', label: 'Eisen', count: '1.505' }, { value: 'Glas', label: 'Glas', count: '4.316' }, { value: 'Holz', label: 'Holz', count: '46.478' }, { value: 'Keramik', label: 'Keramik', count: '97' }, { value: 'Kiefer', label: 'Kiefer', count: '677' }, { value: 'Korb & Rattan', label: 'Korb & Rattan', count: '140' }, { value: 'Kunststoff', label: 'Kunststoff', count: '18.852' }, { value: 'Lackiert', label: 'Lackiert', count: '770' }, { value: 'Leder', label: 'Leder', count: '6.764' }, { value: 'Marmor', label: 'Marmor', count: '229' }, { value: 'Massivholz', label: 'Massivholz', count: '2.238' }, { value: 'Metall', label: 'Metall', count: '20.519' }, { value: 'Samt', label: 'Samt', count: '392' }, { value: 'Schichtstoff', label: 'Schichtstoff', count: '981' }, { value: 'Stahl', label: 'Stahl', count: '2.762' }, { value: 'Stein', label: 'Stein', count: '94' }, { value: 'Stoff', label: 'Stoff', count: '9.752' }, { value: 'Sonstige', label: 'Sonstige', count: '28.441' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Zustand</h4><div className="space-y-2">
                    {[{ value: 'Neu', label: 'Neu', count: '31.474' }, { value: 'Sehr Gut', label: 'Sehr Gut', count: '107.849' }, { value: 'Gut', label: 'Gut', count: '66.318' }, { value: 'In Ordnung', label: 'In Ordnung', count: '12.991' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Paketdienst</h4><div className="space-y-2">
                    {[{ value: 'DHL', label: 'DHL', count: '75.334' }, { value: 'Hermes', label: 'Hermes', count: '72.929' }].map(option => (
                ...
                <div className="mb-6"><h4 className="font-bold text-gray-900 mb-3 text-base">Ort</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Baden-Württemberg', label: 'Baden-Württemberg', count: '33.754' }, { value: 'Bayern', label: 'Bayern', count: '43.159' }, { value: 'Berlin', label: 'Berlin', count: '18.577' }, { value: 'Brandenburg', label: 'Brandenburg', count: '6.121' }, { value: 'Bremen', label: 'Bremen', count: '1.988' }, { value: 'Hamburg', label: 'Hamburg', count: '8.556' }, { value: 'Hessen', label: 'Hessen', count: '24.692' }, { value: 'Mecklenburg-Vorpommern', label: 'Mecklenburg-Vorpommern', count: '2.672' }, { value: 'Niedersachsen', label: 'Niedersachsen', count: '24.613' }, { value: 'Nordrhein-Westfalen', label: 'Nordrhein-Westfalen', count: '54.718' }, { value: 'Rheinland-Pfalz', label: 'Rheinland-Pfalz', count: '10.591' }, { value: 'Saarland', label: 'Saarland', count: '2.491' }, { value: 'Sachsen', label: 'Sachsen', count: '10.400' }, { value: 'Sachsen-Anhalt', label: 'Sachsen-Anhalt', count: '3.784' }, { value: 'Schleswig-Holstein', label: 'Schleswig-Holstein', count: '9.243' }, { value: 'Thüringen', label: 'Thüringen', count: '3.990' }].map(option => (
            ...
            <div className="flex-1">
                <div className="bg-red-600 rounded-2xl shadow-xl p-8 mb-6 relative overflow-hidden"><div className="absolute inset-0 opacity-10"><div className="absolute top-0 left-0 w-full h-full" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(255,255,255,.1) 35px, rgba(255,255,255,.1) 70px)' }}></div></div>
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Büro</h1><p className="text-white text-lg opacity-90">Büromöbel und Ausstattung</p></div>
                    </div>
