...
function FilmDVDPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Musik, Filme & Bücher' && listing.subCategory === 'Film & DVD' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 454712 }, { value: 'Nur Abholung', count: 47352 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 55427 },
                            { value: 'Sehr Gut', count: 265673 },
                            { value: 'Gut', count: 74601 },
                            { value: 'In Ordnung', count: 6301 }
                        ].map(z => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 504891 }, { value: 'Gesuche', count: 1313 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 504655 }, { value: 'Gewerblich', count: 1549 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(111.461)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 242274 }, { value: 'Hermes', count: 231505 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 54204 }, { value: 'Bayern', count: 80637 }, { value: 'Berlin', count: 22708 },
                            { value: 'Brandenburg', count: 11806 }, { value: 'Bremen', count: 4456 }, { value: 'Hamburg', count: 12296 },
                            { value: 'Hessen', count: 41564 }, { value: 'Mecklenburg-Vorpommern', count: 7427 }, { value: 'Niedersachsen', count: 56177 },
                            { value: 'Nordrhein-Westfalen', count: 113825 }, { value: 'Rheinland-Pfalz', count: 27169 }, { value: 'Saarland', count: 5145 },
                            { value: 'Sachsen', count: 22765 }, { value: 'Sachsen-Anhalt', count: 9880 }, { value: 'Schleswig-Holstein', count: 26887 },
                            { value: 'Thüringen', count: 9258 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="20" y="22" width="24" height="20" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                                <rect x="20" y="22" width="24" height="20" strokeWidth="2.5" rx="2" />
                                <path d="M28 28 L36 32 L28 36 Z" fill="currentColor" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Film & DVD</h1><p className="text-white text-lg opacity-90">Film & DVD</p></div>
                    </div>
