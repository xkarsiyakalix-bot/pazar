...
function SammelnPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Sammeln' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Ansichts- & Postkarten', count: 40029 },
                            { value: 'Autogramme', count: 38029 },
                            { value: 'Bierkrüge & -gläser', count: 92000 },
                            { value: 'Briefmarken', count: 76413 },
                            { value: 'Comics', count: 36553 },
                            { value: 'Flaggen', count: 5349 },
                            { value: 'Münzen', count: 187224 },
                            { value: 'Porzellan', count: 333469 },
                            { value: 'Puppen & Puppenzubehör', count: 89934 },
                            { value: 'Sammelbilder & Sticker', count: 130477 },
                            { value: 'Sammelkartenspiele', count: 193470 },
                            { value: 'Überraschungseier', count: 44463 },
                            { value: 'Werbeartikel', count: 103564 },
                            { value: 'Weiteres Sammeln', count: 889595 }
                        ].map(art => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 2008441 }, { value: 'Nur Abholung', count: 240231 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 429720 },
                            { value: 'Sehr Gut', count: 915739 },
                            { value: 'Gut', count: 352782 },
                            { value: 'In Ordnung', count: 69761 }
                        ].map(z => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 2245375 }, { value: 'Gesuche', count: 15375 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 2241118 }, { value: 'Gewerblich', count: 19632 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(503.539)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 1269746 }, { value: 'Hermes', count: 1196860 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 244602 }, { value: 'Bayern', count: 369351 }, { value: 'Berlin', count: 103503 },
                            { value: 'Brandenburg', count: 67723 }, { value: 'Bremen', count: 17255 }, { value: 'Hamburg', count: 50632 },
                            { value: 'Hessen', count: 172076 }, { value: 'Mecklenburg-Vorpommern', count: 33621 }, { value: 'Niedersachsen', count: 231740 },
                            { value: 'Nordrhein-Westfalen', count: 500779 }, { value: 'Rheinland-Pfalz', count: 110987 }, { value: 'Saarland', count: 30914 },
                            { value: 'Sachsen', count: 125887 }, { value: 'Sachsen-Anhalt', count: 54212 }, { value: 'Schleswig-Holstein', count: 93595 },
                            { value: 'Thüringen', count: 53873 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="18" y="18" width="28" height="28" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                                <rect x="18" y="18" width="28" height="28" strokeWidth="2.5" rx="2" />
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Sammeln</h1><p className="text-white text-lg opacity-90">Sammeln</p></div>
                    </div>
