...
function GastronomieTourismusPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Jobs' && listing.subCategory === 'Gastronomie & Tourismus' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Barkeeper/-in', count: 434 },
                            { value: 'Hotelfachmann/-frau', count: 998 },
                            { value: 'Kellner/-in', count: 2447 },
                            { value: 'Koch/Köchin', count: 4552 },
                            { value: 'Küchenhilfe', count: 3566 },
                            { value: 'Servicekraft', count: 4033 },
                            { value: 'Housekeeping', count: 719 },
                            { value: 'Weitere Berufe', count: 3382 }
                        ].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Vollzeit', count: 5273 }, { value: 'Teilzeit', count: 2903 }].map(time => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 17473 }, { value: 'Gesuche', count: 2662 }].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 2663 }, { value: 'Gewerblich', count: 17472 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 2326 }, { value: 'Bayern', count: 2901 }, { value: 'Berlin', count: 1496 },
                            { value: 'Brandenburg', count: 749 }, { value: 'Bremen', count: 194 }, { value: 'Hamburg', count: 829 },
                            { value: 'Hessen', count: 1579 }, { value: 'Mecklenburg-Vorpommern', count: 633 }, { value: 'Niedersachsen', count: 2021 },
                            { value: 'Nordrhein-Westfalen', count: 3981 }, { value: 'Rheinland-Pfalz', count: 851 }, { value: 'Saarland', count: 204 },
                            { value: 'Sachsen', count: 735 }, { value: 'Sachsen-Anhalt', count: 434 }, { value: 'Schleswig-Holstein', count: 826 },
                            { value: 'Thüringen', count: 376 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <circle cx="32" cy="26" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3" /><circle cx="32" cy="26" r="6" strokeWidth="2.5" /><path d="M26 32 L26 42 M38 32 L38 42 M22 42 L42 42" strokeWidth="2.5" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Gastronomie & Tourismus</h1><p className="text-white text-lg opacity-90">Gastronomie & Tourismus</p></div>
                    </div>
