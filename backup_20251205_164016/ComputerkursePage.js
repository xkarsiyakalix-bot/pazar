...
function ComputerkursePage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Computerkurse' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6"><h4 className="font-bold text-gray-900 mb-3 text-base">Ort</h4><div className="space-y-2">
                    {[
                        ...
                        { value: 'Bayern', count: 56 },
                        { value: 'Berlin', count: 24 },
                        { value: 'Brandenburg', count: 5 },
                        { value: 'Bremen', count: 0 },
                        { value: 'Hamburg', count: 7 },
                        { value: 'Hessen', count: 18 },
                        { value: 'Mecklenburg-Vorpommern', count: 0 },
                        { value: 'Niedersachsen', count: 20 },
                        { value: 'Nordrhein-Westfalen', count: 50 },
                        { value: 'Rheinland-Pfalz', count: 8 },
                        { value: 'Saarland', count: 6 },
                        { value: 'Sachsen', count: 17 },
                        { value: 'Sachsen-Anhalt', count: 6 },
                        { value: 'Schleswig-Holstein', count: 16 },
                        { value: 'Thüringen', count: 8 }
                    ].map(state => (
            ...
            <div className="flex-1">
                <div className="bg-red-600 rounded-2xl shadow-xl p-8 mb-6 relative overflow-hidden"><div className="absolute inset-0 opacity-10"><div className="absolute top-0 left-0 w-full h-full" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(255,255,255,.1) 35px, rgba(255,255,255,.1) 70px)' }}></div></div>
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Computerkurse</h1><p className="text-white text-lg opacity-90">Computer Kurse</p></div>
                    </div>
...
export default ComputerkursePage;
