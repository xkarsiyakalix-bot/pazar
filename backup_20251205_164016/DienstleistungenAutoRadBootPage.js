...
function DienstleistungenAutoRadBootPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Auto, Rad & Boot' &&
                ...
                <div className="flex gap-6">
                    <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(44.458)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(7.773)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(11.613)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(40.618)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                {[
                                    { value: 'Baden-Württemberg', count: 5716 },
                                    { value: 'Bayern', count: 6763 },
                                    { value: 'Berlin', count: 2637 },
                                    { value: 'Brandenburg', count: 1543 },
                                    { value: 'Bremen', count: 504 },
                                    { value: 'Hamburg', count: 899 },
                                    { value: 'Hessen', count: 3734 },
                                    { value: 'Mecklenburg-Vorpommern', count: 836 },
                                    { value: 'Niedersachsen', count: 5361 },
                                    { value: 'Nordrhein-Westfalen', count: 15740 },
                                    { value: 'Rheinland-Pfalz', count: 1957 },
                                    { value: 'Saarland', count: 741 },
                                    { value: 'Sachsen', count: 1856 },
                                    { value: 'Sachsen-Anhalt', count: 894 },
                                    { value: 'Schleswig-Holstein', count: 2058 },
                                    { value: 'Thüringen', count: 992 }
                                ].map(state => (
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 className="text-4xl font-bold text-white mb-1">Auto, Rad & Boot</h1>
                                            <p className="text-white text-lg opacity-90">Auto, Rad & Boot Dienstleistungen</p>
                                        </div>
                                    </div>
