...
function KinderwagenBuggysPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Familie, Kind & Baby' && listing.subCategory === 'Kinderwagen & Buggys' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 48px)' }}>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Beige', count: 6651 }, { value: 'Blau', count: 20720 }, { value: 'Braun', count: 8533 }, { value: 'Bunt', count: 1123 },
                            { value: 'Creme', count: 983 }, { value: 'Gelb', count: 377 }, { value: 'Gold', count: 280 }, { value: 'Grau', count: 48150 },
                            { value: 'Grün', count: 5352 }, { value: 'Khaki', count: 1409 }, { value: 'Lavendel', count: 66 }, { value: 'Lila', count: 992 },
                            { value: 'Orange', count: 696 }, { value: 'Pink', count: 1750 }, { value: 'Print', count: 39 }, { value: 'Rot', count: 4394 },
                            { value: 'Schwarz', count: 42180 }, { value: 'Silber', count: 702 }, { value: 'Türkis', count: 1341 }, { value: 'Weiß', count: 1752 },
                            { value: 'Andere Farben', count: 13046 }
                        ].map(color => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 185977 }, { value: 'Gesuche', count: 288 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 183412 }, { value: 'Gewerblich', count: 2853 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 25837 }, { value: 'Bayern', count: 34319 }, { value: 'Berlin', count: 7145 },
                            { value: 'Brandenburg', count: 4571 }, { value: 'Bremen', count: 1305 }, { value: 'Hamburg', count: 4181 },
                            { value: 'Hessen', count: 14740 }, { value: 'Mecklenburg-Vorpommern', count: 2521 }, { value: 'Niedersachsen', count: 19216 },
                            { value: 'Nordrhein-Westfalen', count: 39376 }, { value: 'Rheinland-Pfalz', count: 8922 }, { value: 'Saarland', count: 2074 },
                            { value: 'Sachsen', count: 8079 }, { value: 'Sachsen-Anhalt', count: 3824 }, { value: 'Schleswig-Holstein', count: 6229 },
                            { value: 'Thüringen', count: 3926 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <circle cx="24" cy="42" r="4" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <circle cx="40" cy="42" r="4" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <circle cx="24" cy="42" r="4" strokeWidth="2.5" />
                                <circle cx="40" cy="42" r="4" strokeWidth="2.5" />
                                <path d="M20 32 L20 24 Q20 20 24 20 L40 20 Q44 20 44 24 L44 32" strokeWidth="2.5" strokeLinecap="round" />
                                <path d="M20 32 L44 32 L44 38 L20 38 Z" strokeWidth="2.5" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Kinderwagen & Buggys</h1><p className="text-white text-lg opacity-90">Kinderwagen & Buggys</p></div>
                    </div>
