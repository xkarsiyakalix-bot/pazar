...
function KunstAntiquitaetenPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Kunst & Antiquitäten' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 589296 }, { value: 'Nur Abholung', count: 267797 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 859485 }, { value: 'Gesuche', count: 2546 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 826992 }, { value: 'Gewerblich', count: 35039 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(149.712)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 406611 }, { value: 'Hermes', count: 380646 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 106311 }, { value: 'Bayern', count: 153874 }, { value: 'Berlin', count: 41356 },
                            { value: 'Brandenburg', count: 22107 }, { value: 'Bremen', count: 6050 }, { value: 'Hamburg', count: 21981 },
                            { value: 'Hessen', count: 65837 }, { value: 'Mecklenburg-Vorpommern', count: 10553 }, { value: 'Niedersachsen', count: 84131 },
                            { value: 'Nordrhein-Westfalen', count: 184629 }, { value: 'Rheinland-Pfalz', count: 45846 }, { value: 'Saarland', count: 12495 },
                            { value: 'Sachsen', count: 38755 }, { value: 'Sachsen-Anhalt', count: 16664 }, { value: 'Schleswig-Holstein', count: 35032 },
                            { value: 'Thüringen', count: 16410 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="18" y="16" width="28" height="32" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                                <rect x="18" y="16" width="28" height="32" strokeWidth="2.5" rx="2" />
                                <path d="M26 28 Q32 24 38 28 Q32 32 26 28" strokeWidth="2" fill="currentColor" opacity="0.5" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Kunst & Antiquitäten</h1><p className="text-white text-lg opacity-90">Kunst & Antiquitäten</p></div>
                    </div>
