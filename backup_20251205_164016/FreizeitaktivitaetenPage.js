...
function FreizeitaktivitaetenPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Freizeitaktivitäten' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 134666 }, { value: 'Gesuche', count: 3240 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 133155 }, { value: 'Gewerblich', count: 4751 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 17303 }, { value: 'Bayern', count: 23870 }, { value: 'Berlin', count: 5497 },
                            { value: 'Brandenburg', count: 4377 }, { value: 'Bremen', count: 995 }, { value: 'Hamburg', count: 3158 },
                            { value: 'Hessen', count: 9792 }, { value: 'Mecklenburg-Vorpommern', count: 2425 }, { value: 'Niedersachsen', count: 15350 },
                            { value: 'Nordrhein-Westfalen', count: 28550 }, { value: 'Rheinland-Pfalz', count: 6309 }, { value: 'Saarland', count: 1445 },
                            { value: 'Sachsen', count: 7111 }, { value: 'Sachsen-Anhalt', count: 2877 }, { value: 'Schleswig-Holstein', count: 5964 },
                            { value: 'Thüringen', count: 2883 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                ...
                                <path d="M32 20 L32 32 L40 32" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                                <circle cx="24" cy="24" r="2" fill="currentColor" />
                                <circle cx="40" cy="24" r="2" fill="currentColor" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Freizeitaktivitäten</h1><p className="text-white text-lg opacity-90">Freizeitaktivitäten</p></div>
                    </div>
