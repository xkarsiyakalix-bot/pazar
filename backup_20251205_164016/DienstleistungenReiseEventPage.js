...
function DienstleistungenReiseEventPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Reise & Event' &&
                ...
                <div className="flex gap-6">
                    <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(37.679)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(564)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(14.875)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(23.368)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                {[
                                    { value: 'Baden-Württemberg', count: 3577 },
                                    { value: 'Bayern', count: 5190 },
                                    { value: 'Berlin', count: 1419 },
                                    { value: 'Brandenburg', count: 1059 },
                                    { value: 'Bremen', count: 255 },
                                    { value: 'Hamburg', count: 915 },
                                    { value: 'Hessen', count: 2545 },
                                    { value: 'Mecklenburg-Vorpommern', count: 739 },
                                    { value: 'Niedersachsen', count: 5001 },
                                    { value: 'Nordrhein-Westfalen', count: 10330 },
                                    { value: 'Rheinland-Pfalz', count: 1610 },
                                    { value: 'Saarland', count: 524 },
                                    { value: 'Sachsen', count: 1562 },
                                    { value: 'Sachsen-Anhalt', count: 671 },
                                    { value: 'Schleswig-Holstein', count: 1731 },
                                    { value: 'Thüringen', count: 1115 }
                                ].map(state => (
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 className="text-4xl font-bold text-white mb-1">Reise & Event</h1>
                                            <p className="text-white text-lg opacity-90">Reise & Event Dienstleistungen</p>
                                        </div>
                                    </div>
