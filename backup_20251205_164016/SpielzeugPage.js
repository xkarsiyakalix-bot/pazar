...
function SpielzeugPage() {
    ...
    const resetFilters = () => {
        setCategory(''); setPriceFrom(''); setPriceTo(''); setSelectedToyType(''); setShippingOption('');
        setSelectedCondition(''); setOfferType(''); setProviderType(''); setDirectPurchase('');
        setDeliveryService(''); setSelectedState('');
    };

    const filteredListings = listings.filter(listing =>
        listing.category === 'Familie, Kind & Baby' && listing.subCategory === 'Spielzeug' &&
        ...
        (!selectedToyType || listing.toyType === selectedToyType) && (!shippingOption || listing.shippingOption === shippingOption) &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 48px)' }}>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Action- & Spielfiguren', count: 420940 },
                            { value: 'Babyspielzeug', count: 166955 },
                            { value: 'Barbie & Co', count: 107917 },
                            { value: 'Dreirad & Co', count: 112285 },
                            { value: 'Gesellschaftsspiele', count: 517502 },
                            { value: 'Holzspielzeug', count: 273139 },
                            { value: 'LEGO & Duplo', count: 684737 },
                            { value: 'Lernspielzeug', count: 397577 },
                            { value: 'Playmobil', count: 521941 },
                            { value: 'Puppen', count: 191714 },
                            { value: 'Spielzeugautos', count: 252352 },
                            { value: 'Spielzeug für draußen', count: 158231 },
                            { value: 'Stofftiere', count: 232819 },
                            { value: 'Weiteres Spielzeug', count: 1149048 }
                        ].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                                    <input type="radio" name="toyType" value={type.value} checked={selectedToyType === type.value} onChange={(e) => setSelectedToyType(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 3945293 }, { value: 'Nur Abholung', count: 1230273 }].map(shipping => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 633491 }, { value: 'Sehr Gut', count: 2689989 },
                            { value: 'Gut', count: 1131200 }, { value: 'In Ordnung', count: 150117 }
                        ].map(condition => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 5178822 }, { value: 'Gesuche', count: 8550 }].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 5160962 }, { value: 'Gewerblich', count: 26410 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(1.279.898)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 3034311 }, { value: 'Hermes', count: 2840619 }].map(service => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 611937 }, { value: 'Bayern', count: 839587 }, { value: 'Berlin', count: 185552 },
                            { value: 'Brandenburg', count: 145561 }, { value: 'Bremen', count: 35681 }, { value: 'Hamburg', count: 123646 },
                            { value: 'Hessen', count: 383070 }, { value: 'Mecklenburg-Vorpommern', count: 75907 }, { value: 'Niedersachsen', count: 620966 },
                            { value: 'Nordrhein-Westfalen', count: 1185615 }, { value: 'Rheinland-Pfalz', count: 239145 }, { value: 'Saarland', count: 55303 },
                            { value: 'Sachsen', count: 241380 }, { value: 'Sachsen-Anhalt', count: 99809 }, { value: 'Schleswig-Holstein', count: 244118 },
                            { value: 'Thüringen', count: 100095 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <circle cx="32" cy="32" r="8" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <circle cx="32" cy="32" r="8" strokeWidth="2.5" />
                                <path d="M24 24 L40 40 M40 24 L24 40" strokeWidth="2.5" strokeLinecap="round" />
                                <rect x="28" y="18" width="8" height="4" strokeWidth="2" rx="1" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Spielzeug</h1><p className="text-white text-lg opacity-90">Spielzeug</p></div>
                    </div>
