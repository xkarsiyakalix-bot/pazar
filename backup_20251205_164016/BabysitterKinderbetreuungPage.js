...
function BabysitterKinderbetreuungPage() {
    ...
    const resetFilters = () => {
        setCategory(''); setPriceFrom(''); setPriceTo('');
        setOfferType(''); setProviderType(''); setSelectedState('');
    };

    const filteredListings = listings.filter(listing =>
        listing.category === 'Familie, Kind & Baby' && listing.subCategory === 'Babysitter/-in & Kinderbetreuung' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <button className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                            <span>Babysitter/-in & Kinderbetreuung</span>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 4234 }, { value: 'Gesuche', count: 1164 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 3374 }, { value: 'Gewerblich', count: 2024 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 684 }, { value: 'Bayern', count: 698 }, { value: 'Berlin', count: 227 },
                            { value: 'Brandenburg', count: 118 }, { value: 'Bremen', count: 38 }, { value: 'Hamburg', count: 138 },
                            { value: 'Hessen', count: 397 }, { value: 'Mecklenburg-Vorpommern', count: 80 }, { value: 'Niedersachsen', count: 796 },
                            { value: 'Nordrhein-Westfalen', count: 1331 }, { value: 'Rheinland-Pfalz', count: 214 }, { value: 'Saarland', count: 50 },
                            { value: 'Sachsen', count: 137 }, { value: 'Sachsen-Anhalt', count: 48 }, { value: 'Schleswig-Holstein', count: 374 },
                            { value: 'Thüringen', count: 68 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <circle cx="32" cy="24" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <circle cx="32" cy="24" r="6" strokeWidth="2.5" />
                                <path d="M22 36 Q22 32 26 32 L38 32 Q42 32 42 36 L42 42" strokeWidth="2.5" strokeLinecap="round" />
                                <circle cx="28" cy="22" r="1.5" fill="currentColor" />
                                <circle cx="36" cy="22" r="1.5" fill="currentColor" />
                                <path d="M28 26 Q32 28 36 26" strokeWidth="2" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Babysitter/-in & Kinderbetreuung</h1><p className="text-white text-lg opacity-90">Babysitter/-in & Kinderbetreuung</p></div>
                    </div>
