...
function DienstleistungenWeiterePage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Weitere Dienstleistungen' &&
                ...
                <div className="flex gap-6">
                    <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(51.532)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(4.516)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(20.565)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(35.483)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                {[
                                    { value: 'Baden-Württemberg', count: 6037 },
                                    { value: 'Bayern', count: 8333 },
                                    { value: 'Berlin', count: 2768 },
                                    { value: 'Brandenburg', count: 1378 },
                                    { value: 'Bremen', count: 429 },
                                    { value: 'Hamburg', count: 1290 },
                                    { value: 'Hessen', count: 4288 },
                                    { value: 'Mecklenburg-Vorpommern', count: 828 },
                                    { value: 'Niedersachsen', count: 7031 },
                                    { value: 'Nordrhein-Westfalen', count: 14773 },
                                    { value: 'Rheinland-Pfalz', count: 2220 },
                                    { value: 'Saarland', count: 557 },
                                    { value: 'Sachsen', count: 2183 },
                                    { value: 'Sachsen-Anhalt', count: 980 },
                                    { value: 'Schleswig-Holstein', count: 1893 },
                                    { value: 'Thüringen', count: 1060 }
                                ].map(state => (
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 className="text-4xl font-bold text-white mb-1">Weitere Dienstleistungen</h1>
                                            <p className="text-white text-lg opacity-90">Weitere Dienstleistungen</p>
                                        </div>
                                    </div>
