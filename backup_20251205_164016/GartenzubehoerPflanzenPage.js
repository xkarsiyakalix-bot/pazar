...
function GartenzubehoerPflanzenPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Gartenzubehör & Pflanzen' &&
        ...
        <div className="min-h-screen bg-gray-50"><div className="max-w-[1400px] mx-auto px-4 py-6"><div className="flex gap-6">
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <button className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                            <span>Gartenzubehör & Pflanzen</span>
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Art</h4><div className="space-y-2">
                    {[{ value: 'Blumentöpfe', label: 'Blumentöpfe', count: '70.735' }, { value: 'Dekoration', label: 'Dekoration', count: '22.347' }, { value: 'Gartengeräte', label: 'Gartengeräte', count: '146.769' }, { value: 'Gartenmöbel', label: 'Gartenmöbel', count: '104.493' }, { value: 'Pflanzen', label: 'Pflanzen', count: '132.065' }, { value: 'Weiteres Gartenzubehör & Pflanzen', label: 'Weiteres Gartenzubehör & Pflanzen', count: '48.147' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Versand</h4><div className="space-y-2">
                    {[{ value: 'Versand möglich', label: 'Versand möglich', count: '237.968' }, { value: 'Nur Abholung', label: 'Nur Abholung', count: '285.869' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Farbe</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Beige', label: 'Beige', count: '8.653' }, { value: 'Blau', label: 'Blau', count: '15.510' }, { value: 'Braun', label: 'Braun', count: '21.898' }, { value: 'Bunt', label: 'Bunt', count: '6.678' }, { value: 'Burgunderrot', label: 'Burgunderrot', count: '660' }, { value: 'Gelb', label: 'Gelb', count: '7.405' }, { value: 'Gold', label: 'Gold', count: '1.075' }, { value: 'Grau', label: 'Grau', count: '37.050' }, { value: 'Grün', label: 'Grün', count: '61.793' }, { value: 'Holz', label: 'Holz', count: '10.270' }, { value: 'Khaki', label: 'Khaki', count: '163' }, { value: 'Lila', label: 'Lila', count: '3.226' }, { value: 'Orange', label: 'Orange', count: '11.544' }, { value: 'Rosa', label: 'Rosa', count: '3.959' }, { value: 'Rot', label: 'Rot', count: '19.036' }, { value: 'Schwarz', label: 'Schwarz', count: '26.759' }, { value: 'Silber', label: 'Silber', count: '7.168' }, { value: 'Transparent', label: 'Transparent', count: '1.336' }, { value: 'Weiß', label: 'Weiß', count: '23.021' }, { value: 'Andere Farben', label: 'Andere Farben', count: '46.943' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Zustand</h4><div className="space-y-2">
                    {[{ value: 'Neu', label: 'Neu', count: '89.183' }, { value: 'Sehr Gut', label: 'Sehr Gut', count: '156.359' }, { value: 'Gut', label: 'Gut', count: '107.021' }, { value: 'In Ordnung', label: 'In Ordnung', count: '27.078' }, { value: 'Defekt', label: 'Defekt', count: '5.402' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Angebotstyp</h4><div className="space-y-2">
                    {[{ value: 'Angebote', label: 'Angebote', count: '520.826' }, { value: 'Gesuche', label: 'Gesuche', count: '3.784' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Anbieter</h4><div className="space-y-2">
                    {[{ value: 'Privat', label: 'Privat', count: '469.137' }, { value: 'Gewerblich', label: 'Gewerblich', count: '55.473' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Paketdienst</h4><div className="space-y-2">
                    {[{ value: 'DHL', label: 'DHL', count: '162.921' }, { value: 'Hermes', label: 'Hermes', count: '155.015' }].map(option => (
                ...
                <div className="mb-6"><h4 className="font-bold text-gray-900 mb-3 text-base">Ort</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Baden-Württemberg', label: 'Baden-Württemberg', count: '64.787' }, { value: 'Bayern', label: 'Bayern', count: '90.531' }, { value: 'Berlin', label: 'Berlin', count: '16.767' }, { value: 'Brandenburg', label: 'Brandenburg', count: '16.257' }, { value: 'Bremen', label: 'Bremen', count: '3.016' }, { value: 'Hamburg', label: 'Hamburg', count: '9.706' }, { value: 'Hessen', label: 'Hessen', count: '36.801' }, { value: 'Mecklenburg-Vorpommern', label: 'Mecklenburg-Vorpommern', count: '8.745' }, { value: 'Niedersachsen', label: 'Niedersachsen', count: '66.081' }, { value: 'Nordrhein-Westfalen', label: 'Nordrhein-Westfalen', count: '108.923' }, { value: 'Rheinland-Pfalz', label: 'Rheinland-Pfalz', count: '23.473' }, { value: 'Saarland', label: 'Saarland', count: '6.067' }, { value: 'Sachsen', label: 'Sachsen', count: '26.467' }, { value: 'Sachsen-Anhalt', label: 'Sachsen-Anhalt', count: '12.369' }, { value: 'Schleswig-Holstein', label: 'Schleswig-Holstein', count: '23.770' }, { value: 'Thüringen', label: 'Thüringen', count: '10.850' }].map(option => (
            ...
            <div className="flex-1">
                <div className="bg-red-600 rounded-2xl shadow-xl p-8 mb-6 relative overflow-hidden"><div className="absolute inset-0 opacity-10"><div className="absolute top-0 left-0 w-full h-full" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(255,255,255,.1) 35px, rgba(255,255,255,.1) 70px)' }}></div></div>
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Gartenzubehör & Pflanzen</h1><p className="text-white text-lg opacity-90">Alles für Ihren Garten</p></div>
                    </div>
