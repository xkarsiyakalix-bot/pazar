...
function BabyAusstattungPage() {
    ...
    const resetFilters = () => {
        setCategory(''); setPriceFrom(''); setPriceTo(''); setShippingOption(''); setSelectedColor('');
        setSelectedCondition(''); setOfferType(''); setProviderType(''); setDirectPurchase('');
        setDeliveryService(''); setSelectedState('');
    };

    const filteredListings = listings.filter(listing =>
        listing.category === 'Familie, Kind & Baby' && listing.subCategory === 'Baby-Ausstattung' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 48px)' }}>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 611677 }, { value: 'Nur Abholung', count: 264837 }].map(shipping => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Beige', count: 37297 }, { value: 'Blau', count: 72838 }, { value: 'Braun', count: 17818 }, { value: 'Bunt', count: 38998 },
                            { value: 'Creme', count: 11685 }, { value: 'Gelb', count: 10759 }, { value: 'Gold', count: 318 }, { value: 'Grau', count: 111233 },
                            { value: 'Grün', count: 20923 }, { value: 'Khaki', count: 1886 }, { value: 'Lavendel', count: 877 }, { value: 'Lila', count: 5164 },
                            { value: 'Orange', count: 4043 }, { value: 'Pink', count: 20719 }, { value: 'Print', count: 1057 }, { value: 'Rot', count: 11573 },
                            { value: 'Schwarz', count: 44863 }, { value: 'Silber', count: 4585 }, { value: 'Türkis', count: 8007 }, { value: 'Weiß', count: 152268 },
                            { value: 'Andere Farben', count: 124613 }
                        ].map(color => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 112703 }, { value: 'Sehr Gut', count: 498427 },
                            { value: 'Gut', count: 170905 }, { value: 'In Ordnung', count: 17238 }
                        ].map(condition => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 877344 }, { value: 'Gesuche', count: 641 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 874088 }, { value: 'Gewerblich', count: 3897 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(231.171)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 523208 }, { value: 'Hermes', count: 482893 }].map(service => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 124607 }, { value: 'Bayern', count: 172555 }, { value: 'Berlin', count: 28383 },
                            { value: 'Brandenburg', count: 24125 }, { value: 'Bremen', count: 5048 }, { value: 'Hamburg', count: 17542 },
                            { value: 'Hessen', count: 66957 }, { value: 'Mecklenburg-Vorpommern', count: 12961 }, { value: 'Niedersachsen', count: 92552 },
                            { value: 'Nordrhein-Westfalen', count: 164395 }, { value: 'Rheinland-Pfalz', count: 43463 }, { value: 'Saarland', count: 9993 },
                            { value: 'Sachsen', count: 44936 }, { value: 'Sachsen-Anhalt', count: 17993 }, { value: 'Schleswig-Holstein', count: 33316 },
                            { value: 'Thüringen', count: 19159 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <circle cx="32" cy="28" r="8" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <circle cx="32" cy="28" r="8" strokeWidth="2.5" />
                                <path d="M24 36 L24 42 M40 36 L40 42" strokeWidth="2.5" strokeLinecap="round" />
                                <circle cx="28" cy="26" r="1.5" fill="currentColor" />
                                <circle cx="36" cy="26" r="1.5" fill="currentColor" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Baby-Ausstattung</h1><p className="text-white text-lg opacity-90">Baby-Ausstattung</p></div>
                    </div>
...
export default BabyAusstattungPage;
