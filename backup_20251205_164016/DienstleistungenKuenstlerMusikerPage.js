...
function DienstleistungenKuenstlerMusikerPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Künstler & Musiker' &&
                ...
                <div className="flex gap-6">
                    <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(17.855)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(2.460)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(15.407)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(4.908)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                {[
                                    { value: 'Baden-Württemberg', count: 2299 },
                                    { value: 'Bayern', count: 3233 },
                                    { value: 'Berlin', count: 1316 },
                                    { value: 'Brandenburg', count: 563 },
                                    { value: 'Bremen', count: 133 },
                                    { value: 'Hamburg', count: 709 },
                                    { value: 'Hessen', count: 1391 },
                                    { value: 'Mecklenburg-Vorpommern', count: 334 },
                                    { value: 'Niedersachsen', count: 2042 },
                                    { value: 'Nordrhein-Westfalen', count: 4500 },
                                    { value: 'Rheinland-Pfalz', count: 940 },
                                    { value: 'Saarland', count: 200 },
                                    { value: 'Sachsen', count: 1029 },
                                    { value: 'Sachsen-Anhalt', count: 413 },
                                    { value: 'Schleswig-Holstein', count: 778 },
                                    { value: 'Thüringen', count: 435 }
                                ].map(state => (
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 className="text-4xl font-bold text-white mb-1">Künstler & Musiker</h1>
                                            <p className="text-white text-lg opacity-90">Künstler & Musiker Dienstleistungen</p>
                                        </div>
                                    </div>
