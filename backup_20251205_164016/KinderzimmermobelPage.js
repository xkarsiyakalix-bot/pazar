...
function KinderzimmermobelPage() {
    ...
    const resetFilters = () => {
        setCategory(''); setPriceFrom(''); setPriceTo(''); setSelectedFurnitureType(''); setSelectedColor('');
        setSelectedCondition(''); setOfferType(''); setProviderType(''); setSelectedState('');
    };

    const filteredListings = listings.filter(listing =>
        listing.category === 'Familie, Kind & Baby' && listing.subCategory === 'Kinderzimmermöbel' &&
        ...
        (!selectedFurnitureType || listing.furnitureType === selectedFurnitureType) &&
        (!selectedColor || listing.color === selectedColor) && (!selectedCondition || listing.condition === selectedCondition) &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 48px)' }}>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Betten & Wiegen', count: 210497 },
                            { value: 'Hochstühle & Laufställe', count: 72147 },
                            { value: 'Schränke & Kommoden', count: 14575 },
                            { value: 'Wickeltische & Zubehör', count: 26046 },
                            { value: 'Wippen & Schaukeln', count: 15454 },
                            { value: 'Weitere Kinderzimmermöbel', count: 152571 }
                        ].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                                    <input type="radio" name="furnitureType" value={type.value} checked={selectedFurnitureType === type.value} onChange={(e) => setSelectedFurnitureType(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Beige', count: 20573 }, { value: 'Blau', count: 23926 }, { value: 'Braun', count: 25395 }, { value: 'Bunt', count: 18137 },
                            { value: 'Burgunderrot', count: 180 }, { value: 'Creme', count: 3726 }, { value: 'Gelb', count: 2639 }, { value: 'Gold', count: 115 },
                            { value: 'Grau', count: 40694 }, { value: 'Grün', count: 9966 }, { value: 'Holz', count: 45116 }, { value: 'Khaki', count: 114 },
                            { value: 'Lavendel', count: 179 }, { value: 'Lila', count: 1736 }, { value: 'Orange', count: 1676 }, { value: 'Pink', count: 11458 },
                            { value: 'Print', count: 184 }, { value: 'Rot', count: 7580 }, { value: 'Schwarz', count: 7008 }, { value: 'Silber', count: 987 },
                            { value: 'Transparent', count: 234 }, { value: 'Türkis', count: 2236 }, { value: 'Weiß', count: 160288 },
                            { value: 'Andere Farben', count: 38522 }
                        ].map(color => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 20965 }, { value: 'Sehr Gut', count: 253183 },
                            { value: 'Gut', count: 155944 }, { value: 'In Ordnung', count: 24637 }, { value: 'Defekt', count: 353 }
                        ].map(condition => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 490570 }, { value: 'Gesuche', count: 732 }].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 486328 }, { value: 'Gewerblich', count: 4974 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 64847 }, { value: 'Bayern', count: 85561 }, { value: 'Berlin', count: 18653 },
                            { value: 'Brandenburg', count: 14701 }, { value: 'Bremen', count: 3194 }, { value: 'Hamburg', count: 12123 },
                            { value: 'Hessen', count: 38134 }, { value: 'Mecklenburg-Vorpommern', count: 7627 }, { value: 'Niedersachsen', count: 52012 },
                            { value: 'Nordrhein-Westfalen', count: 101435 }, { value: 'Rheinland-Pfalz', count: 23098 }, { value: 'Saarland', count: 5280 },
                            { value: 'Sachsen', count: 23837 }, { value: 'Sachsen-Anhalt', count: 10370 }, { value: 'Schleswig-Holstein', count: 19446 },
                            { value: 'Thüringen', count: 10984 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="20" y="28" width="24" height="16" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                                <rect x="20" y="28" width="24" height="16" strokeWidth="2.5" rx="2" />
                                <path d="M20 36 L16 36 L16 44 M44 36 L48 36 L48 44" strokeWidth="2.5" strokeLinecap="round" />
                                <circle cx="26" cy="32" r="1.5" fill="currentColor" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Kinderzimmermöbel</h1><p className="text-white text-lg opacity-90">Kinderzimmermöbel</p></div>
                    </div>
