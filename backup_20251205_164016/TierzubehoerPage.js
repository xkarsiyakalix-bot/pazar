...
function TierzubehoerPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        (!selectedAnimalType || listing.animalType === selectedAnimalType) &&
    ...
    return (
        <div className="min-h-screen bg-gray-50"><div className="max-w-[1400px] mx-auto px-4 py-6"><div className="flex gap-6">
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">                <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                {/* Art (Animal Type) Filter */}
                <div className="mb-6">
                    <h4 className="font-bold text-gray-900 mb-3 text-base">Art</h4>
                    <div className="space-y-2 max-h-48 overflow-y-auto">
                        {[
                            { value: 'Fische', count: 50547 },
                            { value: 'Hunde', count: 183110 },
                            { value: 'Katzen', count: 58715 },
                            { value: 'Kleintiere', count: 30687 },
                            { value: 'Pferde', count: 426219 },
                            { value: 'Reptilien', count: 8886 },
                            { value: 'Vögel', count: 10778 },
                            { value: 'Weiteres Zubehör Haustiere', count: 26595 }
                        ].map(animal => (
                            <label key={animal.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                                    <input type="radio" name="animalType" value={animal.value} checked={selectedAnimalType === animal.value} onChange={(e) => setSelectedAnimalType(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                                    <span className="ml-2 text-sm text-gray-700">{animal.value}</span>
                                </div>
                                <span className="text-xs text-gray-500">({animal.count.toLocaleString('de-DE')})</span>
                            </label>
                        ))}
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Versand möglich', count: 594288 },
                            { value: 'Nur Abholung', count: 194407 }
                        ].map(shipping => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Angebote', count: 792242 },
                            { value: 'Gesuche', count: 8374 }
                        ].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Privat', count: 766990 },
                            { value: 'Gewerblich', count: 33626 }
                        ].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(185.901)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'DHL', count: 480358 },
                            { value: 'Hermes', count: 432610 }
                        ].map(service => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 86903 },
                            { value: 'Bayern', count: 128831 },
                            { value: 'Berlin', count: 18670 },
                            { value: 'Brandenburg', count: 23173 },
                            { value: 'Bremen', count: 4429 },
                            { value: 'Hamburg', count: 13820 },
                            { value: 'Hessen', count: 59424 },
                            { value: 'Mecklenburg-Vorpommern', count: 12674 },
                            { value: 'Niedersachsen', count: 116373 },
                            { value: 'Nordrhein-Westfalen', count: 177751 },
                            { value: 'Rheinland-Pfalz', count: 38459 },
                            { value: 'Saarland', count: 9411 },
                            { value: 'Sachsen', count: 29537 },
                            { value: 'Sachsen-Anhalt', count: 16195 },
                            { value: 'Schleswig-Holstein', count: 51298 },
                            { value: 'Thüringen', count: 13668 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="22" y="24" width="20" height="16" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Zubehör</h1><p className="text-white text-lg opacity-90">Tierzubehör</p></div>
                    </div>
