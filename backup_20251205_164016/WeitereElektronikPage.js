...
function WeitereElektronikPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Weitere Elektronik' &&
        ...
        <div className="min-h-screen bg-gray-50"><div className="max-w-[1400px] mx-auto px-4 py-6"><div className="flex gap-6">
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">                <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Versand möglich', label: 'Versand möglich', count: '364.091' },
                            { value: 'Nur Abholung', label: 'Nur Abholung', count: '92.294' }
                        ].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Angebote', label: 'Angebote', count: '454.169' },
                            { value: 'Gesuche', label: 'Gesuche', count: '3.722' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Privat', label: 'Privat', count: '422.590' },
                            { value: 'Gewerblich', label: 'Gewerblich', count: '35.301' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <label className="flex items-center justify-between cursor-pointer group">
                        ...
                        <span className="text-xs text-gray-500">(118.866)</span>
                    </label>
                </div>
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'DHL', label: 'DHL', count: '251.038' },
                            { value: 'Hermes', label: 'Hermes', count: '227.548' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', label: 'Baden-Württemberg', count: '62.489' },
                            { value: 'Bayern', label: 'Bayern', count: '76.942' },
                            { value: 'Berlin', label: 'Berlin', count: '17.502' },
                            { value: 'Brandenburg', label: 'Brandenburg', count: '11.418' },
                            { value: 'Bremen', label: 'Bremen', count: '3.788' },
                            { value: 'Hamburg', label: 'Hamburg', count: '9.332' },
                            { value: 'Hessen', label: 'Hessen', count: '35.595' },
                            { value: 'Mecklenburg-Vorpommern', label: 'Mecklenburg-Vorpommern', count: '5.823' },
                            { value: 'Niedersachsen', label: 'Niedersachsen', count: '47.181' },
                            { value: 'Nordrhein-Westfalen', label: 'Nordrhein-Westfalen', count: '104.588' },
                            { value: 'Rheinland-Pfalz', label: 'Rheinland-Pfalz', count: '24.207' },
                            { value: 'Saarland', label: 'Saarland', count: '4.908' },
                            { value: 'Sachsen', label: 'Sachsen', count: '20.535' },
                            { value: 'Sachsen-Anhalt', label: 'Sachsen-Anhalt', count: '9.036' },
                            { value: 'Schleswig-Holstein', label: 'Schleswig-Holstein', count: '15.200' },
                            { value: 'Thüringen', label: 'Thüringen', count: '9.347' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
            ...
            <div className="flex-1">
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <circle cx="32" cy="32" r="14" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Weitere Elektronik</h1><p className="text-white text-lg opacity-90">Weitere Elektronik</p></div>
                    </div>
                ...
                <div style={{ maxWidth: '960px' }}>
                    <CategoryGallery
                        category="Elektronik"
                        subCategory="Weitere Elektronik"
...
export default WeitereElektronikPage;
