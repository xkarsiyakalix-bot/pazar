...
function SprachkursePage() {
    ...
    const filteredListings = listings.filter(listing => listing.category === 'Unterricht & Kurse' && listing.subCategory === 'Sprachkurse');
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <circle cx="28" cy="28" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="28" cy="28" r="6" strokeWidth="2.5"/><circle cx="38" cy="32" r="5" strokeWidth="2" fill="none"/><path d="M24 34 Q28 38 32 34" strokeWidth="2" strokeLinecap="round"/>
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Sprachkurse</h1><p className="text-white text-lg opacity-90">Sprachkurse</p></div>
                    </div>
