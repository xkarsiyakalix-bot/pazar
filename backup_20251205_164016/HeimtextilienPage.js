...
function HeimtextilienPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Heimtextilien' &&
        ...
        <div className="min-h-screen bg-gray-50"><div className="max-w-[1400px] mx-auto px-4 py-6"><div className="flex gap-6">
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Versand</h4><div className="space-y-2">
                    {[{ value: 'Versand möglich', label: 'Versand möglich', count: '328.396' }, { value: 'Nur Abholung', label: 'Nur Abholung', count: '110.426' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Farbe</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Beige', label: 'Beige', count: '35.381' }, { value: 'Blau', label: 'Blau', count: '23.738' }, { value: 'Braun', label: 'Braun', count: '12.797' }, { value: 'Bunt', label: 'Bunt', count: '34.032' }, { value: 'Burgunderrot', label: 'Burgunderrot', count: '2.520' }, { value: 'Gelb', label: 'Gelb', count: '6.019' }, { value: 'Gold', label: 'Gold', count: '2.005' }, { value: 'Grau', label: 'Grau', count: '36.541' }, { value: 'Grün', label: 'Grün', count: '13.118' }, { value: 'Holz', label: 'Holz', count: '479' }, { value: 'Khaki', label: 'Khaki', count: '373' }, { value: 'Lila', label: 'Lila', count: '5.752' }, { value: 'Orange', label: 'Orange', count: '4.850' }, { value: 'Rosa', label: 'Rosa', count: '14.248' }, { value: 'Rot', label: 'Rot', count: '14.999' }, { value: 'Schwarz', label: 'Schwarz', count: '9.586' }, { value: 'Silber', label: 'Silber', count: '3.110' }, { value: 'Transparent', label: 'Transparent', count: '1.350' }, { value: 'Weiß', label: 'Weiß', count: '63.142' }, { value: 'Andere Farben', label: 'Andere Farben', count: '65.964' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Material</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Baumwolle', label: 'Baumwolle', count: '88.371' }, { value: 'Bio-Baumwolle', label: 'Bio-Baumwolle', count: '1.924' }, { value: 'Flanell', label: 'Flanell', count: '1.418' }, { value: 'Kunstpelz', label: 'Kunstpelz', count: '824' }, { value: 'Leinen', label: 'Leinen', count: '6.397' }, { value: 'Mischgewebe', label: 'Mischgewebe', count: '17.768' }, { value: 'Naturfaser', label: 'Naturfaser', count: '2.528' }, { value: 'Papier', label: 'Papier', count: '279' }, { value: 'Perkal', label: 'Perkal', count: '126' }, { value: 'Polyester', label: 'Polyester', count: '43.096' }, { value: 'PVC & Synthetik', label: 'PVC & Synthetik', count: '1.473' }, { value: 'Samt', label: 'Samt', count: '3.301' }, { value: 'Satin (Baumwolle)', label: 'Satin (Baumwolle)', count: '2.268' }, { value: 'Viskose', label: 'Viskose', count: '1.025' }, { value: 'Wachstuch', label: 'Wachstuch', count: '257' }, { value: 'Wolle', label: 'Wolle', count: '16.933' }, { value: 'Sonstige', label: 'Sonstige', count: '76.789' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Zustand</h4><div className="space-y-2">
                    {[{ value: 'Neu', label: 'Neu', count: '109.957' }, { value: 'Sehr Gut', label: 'Sehr Gut', count: '198.745' }, { value: 'Gut', label: 'Gut', count: '60.266' }, { value: 'In Ordnung', label: 'In Ordnung', count: '6.860' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Angebotstyp</h4><div className="space-y-2">
                    {[{ value: 'Angebote', label: 'Angebote', count: '439.294' }, { value: 'Gesuche', label: 'Gesuche', count: '934' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Anbieter</h4><div className="space-y-2">
                    {[{ value: 'Privat', label: 'Privat', count: '431.424' }, { value: 'Gewerblich', label: 'Gewerblich', count: '8.804' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Paketdienst</h4><div className="space-y-2">
                    {[{ value: 'DHL', label: 'DHL', count: '226.659' }, { value: 'Hermes', label: 'Hermes', count: '224.627' }].map(option => (
                ...
                <div className="mb-6"><h4 className="font-bold text-gray-900 mb-3 text-base">Ort</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Baden-Württemberg', label: 'Baden-Württemberg', count: '51.341' }, { value: 'Bayern', label: 'Bayern', count: '77.726' }, { value: 'Berlin', label: 'Berlin', count: '20.304' }, { value: 'Brandenburg', label: 'Brandenburg', count: '9.812' }, { value: 'Bremen', label: 'Bremen', count: '3.368' }, { value: 'Hamburg', label: 'Hamburg', count: '13.321' }, { value: 'Hessen', label: 'Hessen', count: '34.858' }, { value: 'Mecklenburg-Vorpommern', label: 'Mecklenburg-Vorpommern', count: '5.985' }, { value: 'Niedersachsen', label: 'Niedersachsen', count: '48.383' }, { value: 'Nordrhein-Westfalen', label: 'Nordrhein-Westfalen', count: '94.042' }, { value: 'Rheinland-Pfalz', label: 'Rheinland-Pfalz', count: '20.212' }, { value: 'Saarland', label: 'Saarland', count: '5.316' }, { value: 'Sachsen', label: 'Sachsen', count: '20.211' }, { value: 'Sachsen-Anhalt', label: 'Sachsen-Anhalt', count: '8.075' }, { value: 'Schleswig-Holstein', label: 'Schleswig-Holstein', count: '19.230' }, { value: 'Thüringen', label: 'Thüringen', count: '8.044' }].map(option => (
            ...
            <div className="flex-1">
                <div className="bg-red-600 rounded-2xl shadow-xl p-8 mb-6 relative overflow-hidden"><div className="absolute inset-0 opacity-10"><div className="absolute top-0 left-0 w-full h-full" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(255,255,255,.1) 35px, rgba(255,255,255,.1) 70px)' }}></div></div>
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Heimtextilien</h1><p className="text-white text-lg opacity-90">Textilien für Ihr Zuhause</p></div>
                    </div>
