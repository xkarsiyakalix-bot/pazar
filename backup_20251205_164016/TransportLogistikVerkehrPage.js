...
function TransportLogistikVerkehrPage() {
    ...
    const resetFilters = () => {
        setHourlyWageFrom(''); setHourlyWageTo(''); setSelectedJobType(''); setWorkingTime('');
        setOfferType(''); setProviderType(''); setSelectedState('');
    };

    const filteredListings = listings.filter(listing =>
        listing.category === 'Jobs' && listing.subCategory === 'Transport, Logistik & Verkehr' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <div className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                            <span>Transport, Logistik & Verkehr</span>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Kraftfahrer/-in', count: 14090 },
                            { value: 'Kurierfahrer/-in', count: 8316 },
                            { value: 'Lagerhelfer/-in', count: 10939 },
                            { value: 'Staplerfahrer/-in', count: 7292 },
                            { value: 'Weitere Berufe', count: 10829 }
                        ].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                                    <input type="radio" name="jobType" value={type.value} checked={selectedJobType === type.value} onChange={(e) => setSelectedJobType(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Vollzeit', count: 25258 }, { value: 'Teilzeit', count: 2796 }].map(time => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 47206 }, { value: 'Gesuche', count: 4268 }].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 4264 }, { value: 'Gewerblich', count: 47210 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 4143 }, { value: 'Bayern', count: 7011 }, { value: 'Berlin', count: 1833 },
                            { value: 'Brandenburg', count: 1537 }, { value: 'Bremen', count: 724 }, { value: 'Hamburg', count: 2152 },
                            { value: 'Hessen', count: 3643 }, { value: 'Mecklenburg-Vorpommern', count: 857 }, { value: 'Niedersachsen', count: 7030 },
                            { value: 'Nordrhein-Westfalen', count: 14082 }, { value: 'Rheinland-Pfalz', count: 1877 }, { value: 'Saarland', count: 295 },
                            { value: 'Sachsen', count: 1729 }, { value: 'Sachsen-Anhalt', count: 1229 }, { value: 'Schleswig-Holstein', count: 2037 },
                            { value: 'Thüringen', count: 1295 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="16" y="28" width="32" height="16" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                                <rect x="16" y="28" width="32" height="16" strokeWidth="2.5" rx="2" />
                                <circle cx="22" cy="44" r="3" strokeWidth="2.5" />
                                <circle cx="42" cy="44" r="3" strokeWidth="2.5" />
                                <path d="M20 28 L20 24 L28 20 L36 20 L44 24 L44 28" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Transport, Logistik & Verkehr</h1><p className="text-white text-lg opacity-90">Transport, Logistik & Verkehr</p></div>
                    </div>
