            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">                <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Angebote', count: 21132 },
                            { value: 'Gesuche', count: 48 }
                        ].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Privat', count: 20576 },
                            { value: 'Gewerblich', count: 604 }
                        ].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 2014 },
                            { value: 'Bayern', count: 3294 },
                            { value: 'Berlin', count: 327 },
                            { value: 'Brandenburg', count: 896 },
                            { value: 'Bremen', count: 122 },
                            { value: 'Hamburg', count: 168 },
                            { value: 'Hessen', count: 1352 },
                            { value: 'Mecklenburg-Vorpommern', count: 852 },
                            { value: 'Niedersachsen', count: 2872 },
                            { value: 'Nordrhein-Westfalen', count: 4418 },
                            { value: 'Rheinland-Pfalz', count: 760 },
                            { value: 'Saarland', count: 259 },
                            { value: 'Sachsen', count: 1173 },
                            { value: 'Sachsen-Anhalt', count: 972 },
                            { value: 'Schleswig-Holstein', count: 783 },
                            { value: 'Thüringen', count: 918 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <path d="M20 32 Q28 24 36 32" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Vögel</h1><p className="text-white text-lg opacity-90">Vögel & Zubehör</p></div>
                    </div>
