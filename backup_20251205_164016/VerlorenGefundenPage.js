...
function VerlorenGefundenPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Verloren & Gefunden' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 1508 }, { value: 'Gesuche', count: 918 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 2387 }, { value: 'Gewerblich', count: 39 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 175 }, { value: 'Bayern', count: 295 }, { value: 'Berlin', count: 193 },
                            { value: 'Brandenburg', count: 81 }, { value: 'Bremen', count: 32 }, { value: 'Hamburg', count: 86 },
                            { value: 'Hessen', count: 135 }, { value: 'Mecklenburg-Vorpommern', count: 104 }, { value: 'Niedersachsen', count: 275 },
                            { value: 'Nordrhein-Westfalen', count: 512 }, { value: 'Rheinland-Pfalz', count: 53 }, { value: 'Saarland', count: 16 },
                            { value: 'Sachsen', count: 214 }, { value: 'Sachsen-Anhalt', count: 70 }, { value: 'Schleswig-Holstein', count: 121 },
                            { value: 'Thüringen', count: 64 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                ...
                                <path d="M32 36 L32 44 M28 44 L36 44" strokeWidth="2.5" strokeLinecap="round" />
                                <path d="M24 20 L40 20" strokeWidth="2.5" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Verloren & Gefunden</h1><p className="text-white text-lg opacity-90">Verloren & Gefunden</p></div>
                    </div>
