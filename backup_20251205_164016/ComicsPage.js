...
function ComicsPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Musik, Filme & Bücher' && listing.subCategory === 'Comics' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 133765 }, { value: 'Nur Abholung', count: 12782 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 14561 },
                            { value: 'Sehr Gut', count: 70829 },
                            { value: 'Gut', count: 29186 },
                            { value: 'In Ordnung', count: 5669 }
                        ].map(z => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 146467 }, { value: 'Gesuche', count: 617 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 146712 }, { value: 'Gewerblich', count: 372 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(38.334)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 84482 }, { value: 'Hermes', count: 78363 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 16178 }, { value: 'Bayern', count: 20000 }, { value: 'Berlin', count: 8948 },
                            { value: 'Brandenburg', count: 3544 }, { value: 'Bremen', count: 1164 }, { value: 'Hamburg', count: 4649 },
                            { value: 'Hessen', count: 11142 }, { value: 'Mecklenburg-Vorpommern', count: 2214 }, { value: 'Niedersachsen', count: 16368 },
                            { value: 'Nordrhein-Westfalen', count: 34301 }, { value: 'Rheinland-Pfalz', count: 7380 }, { value: 'Saarland', count: 1682 },
                            { value: 'Sachsen', count: 7016 }, { value: 'Sachsen-Anhalt', count: 2648 }, { value: 'Schleswig-Holstein', count: 7618 },
                            { value: 'Thüringen', count: 2232 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                ...
                                <path d="M24 24 L40 24 M24 30 L40 30 M24 36 L36 36" strokeWidth="2.5" strokeLinecap="round" />
                                <circle cx="32" cy="28" r="3" fill="currentColor" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Comics</h1><p className="text-white text-lg opacity-90">Comics</p></div>
                    </div>
