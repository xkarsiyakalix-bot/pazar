...
function AusbildungPage() {
    ...
    const resetFilters = () => {
        setCategory(''); setHourlyWageFrom(''); setHourlyWageTo(''); setWorkingTime('');
        setOfferType(''); setProviderType(''); setSelectedState('');
    };

    const filteredListings = listings.filter(listing =>
        listing.category === 'Jobs' && listing.subCategory === 'Ausbildung' &&
        ...
        (!workingTime || listing.workingTime === workingTime) && (!offerType || listing.offerType === offerType) &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Vollzeit', count: 2630 }, { value: 'Teilzeit', count: 272 }].map(time => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 10707 }, { value: 'Gesuche', count: 495 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 495 }, { value: 'Gewerblich', count: 10707 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 1076 }, { value: 'Bayern', count: 1757 }, { value: 'Berlin', count: 492 },
                            { value: 'Brandenburg', count: 285 }, { value: 'Bremen', count: 138 }, { value: 'Hamburg', count: 207 },
                            { value: 'Hessen', count: 524 }, { value: 'Mecklenburg-Vorpommern', count: 239 }, { value: 'Niedersachsen', count: 1629 },
                            { value: 'Nordrhein-Westfalen', count: 3013 }, { value: 'Rheinland-Pfalz', count: 266 }, { value: 'Saarland', count: 72 },
                            { value: 'Sachsen', count: 545 }, { value: 'Sachsen-Anhalt', count: 271 }, { value: 'Schleswig-Holstein', count: 374 },
                            { value: 'Thüringen', count: 314 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="22" y="26" width="20" height="16" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                                <rect x="22" y="26" width="20" height="16" strokeWidth="2.5" rx="2" />
                                <path d="M28 22 L28 26 M36 22 L36 26" strokeWidth="2.5" strokeLinecap="round" />
                                <circle cx="28" cy="32" r="1.5" fill="currentColor" />
                                <circle cx="36" cy="32" r="1.5" fill="currentColor" />
                                <path d="M28 36 Q32 38 36 36" strokeWidth="2" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Ausbildung</h1><p className="text-white text-lg opacity-90">Ausbildung</p></div>
                    </div>
