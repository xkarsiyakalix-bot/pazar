...
function BeautyGesundheitPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Beauty & Gesundheit' &&
        ...
        <div className="min-h-screen bg-gray-50"><div className="max-w-[1400px] mx-auto px-4 py-6"><div className="flex gap-6">
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Art</h4><div className="space-y-2">
                    {[{ value: 'Make-Up & Gesichtspflege', label: 'Make-Up & Gesichtspflege', count: '109.972' }, { value: 'Haarpflege', label: 'Haarpflege', count: '105.234' }, { value: 'Körperpflege', label: 'Körperpflege', count: '64.023' }, { value: 'Hand- & Nagelpflege', label: 'Hand- & Nagelpflege', count: '41.917' }, { value: 'Gesundheit', label: 'Gesundheit', count: '102.299' }, { value: 'Weiteres Beauty & Gesundheit', label: 'Weiteres Beauty & Gesundheit', count: '39.854' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Versand</h4><div className="space-y-2">
                    {[{ value: 'Versand möglich', label: 'Versand möglich', count: '392.303' }, { value: 'Nur Abholung', label: 'Nur Abholung', count: '70.514' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Angebotstyp</h4><div className="space-y-2">
                    {[{ value: 'Angebote', label: 'Angebote', count: '460.528' }, { value: 'Gesuche', label: 'Gesuche', count: '3.034' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Anbieter</h4><div className="space-y-2">
                    {[{ value: 'Privat', label: 'Privat', count: '447.432' }, { value: 'Gewerblich', label: 'Gewerblich', count: '16.130' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Paketdienst</h4><div className="space-y-2">
                    {[{ value: 'DHL', label: 'DHL', count: '283.028' }, { value: 'Hermes', label: 'Hermes', count: '278.303' }].map(option => (
                ...
                <div className="mb-6"><h4 className="font-bold text-gray-900 mb-3 text-base">Ort</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Baden-Württemberg', label: 'Baden-Württemberg', count: '57.741' }, { value: 'Bayern', label: 'Bayern', count: '79.933' }, { value: 'Berlin', label: 'Berlin', count: '25.125' }, { value: 'Brandenburg', label: 'Brandenburg', count: '10.880' }, { value: 'Bremen', label: 'Bremen', count: '3.553' }, { value: 'Hamburg', label: 'Hamburg', count: '14.241' }, { value: 'Hessen', label: 'Hessen', count: '37.724' }, { value: 'Mecklenburg-Vorpommern', label: 'Mecklenburg-Vorpommern', count: '6.099' }, { value: 'Niedersachsen', label: 'Niedersachsen', count: '44.293' }, { value: 'Nordrhein-Westfalen', label: 'Nordrhein-Westfalen', count: '103.077' }, { value: 'Rheinland-Pfalz', label: 'Rheinland-Pfalz', count: '21.542' }, { value: 'Saarland', label: 'Saarland', count: '5.469' }, { value: 'Sachsen', label: 'Sachsen', count: '20.070' }, { value: 'Sachsen-Anhalt', label: 'Sachsen-Anhalt', count: '8.428' }, { value: 'Schleswig-Holstein', label: 'Schleswig-Holstein', count: '16.749' }, { value: 'Thüringen', label: 'Thüringen', count: '8.638' }].map(option => (
            ...
            <div className="flex-1">
                <div className="bg-red-600 rounded-2xl shadow-xl p-8 mb-6 relative overflow-hidden"><div className="absolute inset-0 opacity-10"><div className="absolute top-0 left-0 w-full h-full" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(255,255,255,.1) 35px, rgba(255,255,255,.1) 70px)' }}></div></div>
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Beauty & Gesundheit</h1><p className="text-white text-lg opacity-90">Beauty und Gesundheitsprodukte</p></div>
                    </div>
