            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">                <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Kamera', label: 'Kamera', count: '151.797' },
                            { value: 'Objektiv', label: 'Objektiv', count: '40.584' },
                            { value: 'Zubehör', label: 'Zubehör', count: '75.569' },
                            { value: 'Kamera & Zubehör', label: 'Kamera & Zubehör', count: '21.436' },
                            { value: 'Weiteres Foto', label: 'Weiteres Foto', count: '19.034' }
                        ].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Versand möglich', label: 'Versand möglich', count: '261.673' },
                            { value: 'Nur Abholung', label: 'Nur Abholung', count: '45.440' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', label: 'Neu', count: '38.511' },
                            { value: 'Sehr Gut', label: 'Sehr Gut', count: '143.214' },
                            { value: 'Gut', label: 'Gut', count: '64.712' },
                            { value: 'In Ordnung', label: 'In Ordnung', count: '14.097' },
                            { value: 'Defekt', label: 'Defekt', count: '6.674' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Angebote', label: 'Angebote', count: '308.121' },
                            { value: 'Gesuche', label: 'Gesuche', count: '1.007' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Privat', label: 'Privat', count: '300.919' },
                            { value: 'Gewerblich', label: 'Gewerblich', count: '8.209' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <label className="flex items-center justify-between cursor-pointer group">
                        ...
                        <span className="text-xs text-gray-500">(95.834)</span>
                    </label>
                </div>
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'DHL', label: 'DHL', count: '204.139' },
                            { value: 'Hermes', label: 'Hermes', count: '178.905' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', label: 'Baden-Württemberg', count: '39.473' },
                            { value: 'Bayern', label: 'Bayern', count: '50.830' },
                            { value: 'Berlin', label: 'Berlin', count: '20.396' },
                            { value: 'Brandenburg', label: 'Brandenburg', count: '7.541' },
                            { value: 'Bremen', label: 'Bremen', count: '3.043' },
                            { value: 'Hamburg', label: 'Hamburg', count: '9.654' },
                            { value: 'Hessen', label: 'Hessen', count: '25.318' },
                            { value: 'Mecklenburg-Vorpommern', label: 'Mecklenburg-Vorpommern', count: '3.806' },
                            { value: 'Niedersachsen', label: 'Niedersachsen', count: '28.347' },
                            { value: 'Nordrhein-Westfalen', label: 'Nordrhein-Westfalen', count: '67.556' },
                            { value: 'Rheinland-Pfalz', label: 'Rheinland-Pfalz', count: '13.915' },
                            { value: 'Saarland', label: 'Saarland', count: '3.291' },
                            { value: 'Sachsen', label: 'Sachsen', count: '13.706' },
                            { value: 'Sachsen-Anhalt', label: 'Sachsen-Anhalt', count: '5.098' },
                            { value: 'Schleswig-Holstein', label: 'Schleswig-Holstein', count: '11.796' },
                            { value: 'Thüringen', label: 'Thüringen', count: '5.358' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="18" y="22" width="28" height="20" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="3" />
                                <rect x="18" y="22" width="28" height="20" strokeWidth="2.5" strokeLinecap="round" rx="3" />
                                <circle cx="32" cy="32" r="6" strokeWidth="2" fill="none" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Foto</h1><p className="text-white text-lg opacity-90">Kameras & Fotozubehör</p></div>
                    </div>
