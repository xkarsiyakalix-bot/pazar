...
function DienstleistungenAltenpflegePage() {
                ...
                <div className="flex gap-6">
                    <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(46.692)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(592)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(43.608)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(3.676)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                {[
                                    { value: 'Baden-Württemberg', count: 5645 },
                                    { value: 'Bayern', count: 6750 },
                                    { value: 'Berlin', count: 1934 },
                                    { value: 'Brandenburg', count: 1582 },
                                    { value: 'Bremen', count: 409 },
                                    { value: 'Hamburg', count: 1014 },
                                    { value: 'Hessen', count: 3466 },
                                    { value: 'Mecklenburg-Vorpommern', count: 684 },
                                    { value: 'Niedersachsen', count: 5182 },
                                    { value: 'Nordrhein-Westfalen', count: 11596 },
                                    { value: 'Rheinland-Pfalz', count: 2451 },
                                    { value: 'Saarland', count: 783 },
                                    { value: 'Sachsen', count: 1939 },
                                    { value: 'Sachsen-Anhalt', count: 1132 },
                                    { value: 'Schleswig-Holstein', count: 1812 },
                                    { value: 'Thüringen', count: 905 }
                                ].map(state => (
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 className="text-4xl font-bold text-white mb-1">Altenpflege</h1>
                                            <p className="text-white text-lg opacity-90">Altenpflege Dienstleistungen</p>
                                        </div>
                                    </div>
