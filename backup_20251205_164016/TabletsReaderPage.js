...
function TabletsReaderPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Tablets & Reader' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">                <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'DVD-Player & Recorder', label: 'DVD-Player & Recorder', count: '17.612' },
                            { value: 'Fernseher', label: 'Fernseher', count: '133.638' },
                            { value: 'TV-Receiver', label: 'TV-Receiver', count: '25.746' },
                            { value: 'Weitere TV & Video', label: 'Weitere TV & Video', count: '66.656' }
                        ].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Versand möglich', label: 'Versand möglich', count: '141.360' },
                            { value: 'Nur Abholung', label: 'Nur Abholung', count: '101.579' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', label: 'Neu', count: '30.278' },
                            { value: 'Sehr Gut', label: 'Sehr Gut', count: '107.085' },
                            { value: 'Gut', label: 'Gut', count: '56.326' },
                            { value: 'In Ordnung', label: 'In Ordnung', count: '10.803' },
                            { value: 'Defekt', label: 'Defekt', count: '8.896' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Angebote', label: 'Angebote', count: '242.525' },
                            { value: 'Gesuche', label: 'Gesuche', count: '1.145' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Privat', label: 'Privat', count: '239.874' },
                            { value: 'Gewerblich', label: 'Gewerblich', count: '3.796' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <label className="flex items-center justify-between cursor-pointer group">
                        ...
                        <span className="text-xs text-gray-500">(47.226)</span>
                    </label>
                </div>
                ...
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'DHL', label: 'DHL', count: '109.228' },
                            { value: 'Hermes', label: 'Hermes', count: '103.084' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', label: 'Baden-Württemberg', count: '29.242' },
                            { value: 'Bayern', label: 'Bayern', count: '38.777' },
                            { value: 'Berlin', label: 'Berlin', count: '11.717' },
                            { value: 'Brandenburg', label: 'Brandenburg', count: '6.209' },
                            { value: 'Bremen', label: 'Bremen', count: '2.210' },
                            { value: 'Hamburg', label: 'Hamburg', count: '6.575' },
                            { value: 'Hessen', label: 'Hessen', count: '19.055' },
                            { value: 'Mecklenburg-Vorpommern', label: 'Mecklenburg-Vorpommern', count: '3.539' },
                            { value: 'Niedersachsen', label: 'Niedersachsen', count: '26.914' },
                            { value: 'Nordrhein-Westfalen', label: 'Nordrhein-Westfalen', count: '55.341' },
                            { value: 'Rheinland-Pfalz', label: 'Rheinland-Pfalz', count: '11.277' },
                            { value: 'Saarland', label: 'Saarland', count: '2.851' },
                            { value: 'Sachsen', label: 'Sachsen', count: '11.067' },
                            { value: 'Sachsen-Anhalt', label: 'Sachsen-Anhalt', count: '5.043' },
                            { value: 'Schleswig-Holstein', label: 'Schleswig-Holstein', count: '9.205' },
                            { value: 'Thüringen', label: 'Thüringen', count: '4.648' }
                        ].map(option => (
                            <label key={option.value} className="flex items-center justify-between cursor-pointer group">
                                <div className="flex items-center">
            ...
            <div className="flex-1">
                <div className="bg-red-600 rounded-2xl shadow-xl p-8 mb-6 relative overflow-hidden"><div className="absolute inset-0 opacity-10"><div className="absolute top-0 left-0 w-full h-full" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(255,255,255,.1) 35px, rgba(255,255,255,.1) 70px)' }}></div></div>
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Tablets & Reader</h1><p className="text-white text-lg opacity-90">Tablets & E-Reader</p></div>
                    </div>
