...
function KuenstlerMusikerPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Künstler/-in & Musiker/-in' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <div className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                            <span>Künstler/-in & Musiker/-in</span>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 17864 }, { value: 'Gesuche', count: 2459 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 15424 }, { value: 'Gewerblich', count: 4899 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 2302 }, { value: 'Bayern', count: 3232 }, { value: 'Berlin', count: 1323 },
                            { value: 'Brandenburg', count: 566 }, { value: 'Bremen', count: 134 }, { value: 'Hamburg', count: 701 },
                            { value: 'Hessen', count: 1389 }, { value: 'Mecklenburg-Vorpommern', count: 335 }, { value: 'Niedersachsen', count: 2036 },
                            { value: 'Nordrhein-Westfalen', count: 4512 }, { value: 'Rheinland-Pfalz', count: 943 }, { value: 'Saarland', count: 202 },
                            { value: 'Sachsen', count: 1027 }, { value: 'Sachsen-Anhalt', count: 411 }, { value: 'Schleswig-Holstein', count: 777 },
                            { value: 'Thüringen', count: 433 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <circle cx="32" cy="28" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <circle cx="32" cy="28" r="6" strokeWidth="2.5" />
                                <path d="M32 34 L32 48" strokeWidth="2.5" strokeLinecap="round" />
                                <path d="M20 42 L44 42" strokeWidth="2.5" strokeLinecap="round" />
                                <circle cx="26" cy="20" r="2" fill="currentColor" />
                                <circle cx="38" cy="20" r="2" fill="currentColor" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Künstler/-in & Musiker/-in</h1><p className="text-white text-lg opacity-90">Künstler/-in & Musiker/-in</p></div>
                    </div>
