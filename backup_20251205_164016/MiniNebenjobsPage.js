...
function MiniNebenjobsPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Jobs' && listing.subCategory === 'Mini- & Nebenjobs' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Vollzeit', count: 1235 }, { value: 'Teilzeit', count: 20977 }].map(time => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 42536 }, { value: 'Gesuche', count: 26463 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 26466 }, { value: 'Gewerblich', count: 42533 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 8413 }, { value: 'Bayern', count: 11083 }, { value: 'Berlin', count: 2414 },
                            { value: 'Brandenburg', count: 1912 }, { value: 'Bremen', count: 671 }, { value: 'Hamburg', count: 1574 },
                            { value: 'Hessen', count: 4835 }, { value: 'Mecklenburg-Vorpommern', count: 1293 }, { value: 'Niedersachsen', count: 8286 },
                            { value: 'Nordrhein-Westfalen', count: 17328 }, { value: 'Rheinland-Pfalz', count: 3190 }, { value: 'Saarland', count: 678 },
                            { value: 'Sachsen', count: 2033 }, { value: 'Sachsen-Anhalt', count: 1087 }, { value: 'Schleswig-Holstein', count: 3106 },
                            { value: 'Thüringen', count: 1096 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                ...
                                <path d="M20 44 C20 38 25 36 32 36 C39 36 44 38 44 44" strokeWidth="2.5" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Mini- & Nebenjobs</h1><p className="text-white text-lg opacity-90">Mini- & Nebenjobs</p></div>
                    </div>
