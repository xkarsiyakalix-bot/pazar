...
function WeitereMusikFilmeBuecherPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Musik, Filme & Bücher' &&
        listing.subCategory === 'Weitere Musik, Filme & Bücher' &&
                ...
                <div className="flex gap-6">
                    <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                        <div className="mb-6 pb-6 border-b border-gray-200">
                            ...
                            <div className="space-y-2 mt-3">
                                ...
                                <div className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                                    <span>Weitere Musik, Filme & Bücher</span>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(77.702)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(8.946)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(87.258)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(553)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(87.453)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(358)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(19.057)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(41.030)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(40.723)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                {[
                                    { value: 'Baden-Württemberg', count: 10027 },
                                    { value: 'Bayern', count: 15124 },
                                    { value: 'Berlin', count: 4221 },
                                    { value: 'Brandenburg', count: 2402 },
                                    { value: 'Bremen', count: 537 },
                                    { value: 'Hamburg', count: 3072 },
                                    { value: 'Hessen', count: 5614 },
                                    { value: 'Mecklenburg-Vorpommern', count: 975 },
                                    { value: 'Niedersachsen', count: 8815 },
                                    { value: 'Nordrhein-Westfalen', count: 21090 },
                                    { value: 'Rheinland-Pfalz', count: 4291 },
                                    { value: 'Saarland', count: 828 },
                                    { value: 'Sachsen', count: 3989 },
                                    { value: 'Sachsen-Anhalt', count: 1519 },
                                    { value: 'Schleswig-Holstein', count: 3912 },
                                    { value: 'Thüringen', count: 1395 }
                                ].map(state => (
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 className="text-4xl font-bold text-white mb-1">Weitere Musik, Filme & Bücher</h1>
                                            <p className="text-white text-lg opacity-90">Weitere Musik, Filme & Bücher</p>
                                        </div>
                                    </div>
                                    ...
                                    {filteredListings.map((listing) => (
                                        <div key={listing.id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer group overflow-hidden flex" onClick={() => navigate(`/product/${listing.id}`)}>
                                            <div className="relative w-64 h-48 flex-shrink-0 bg-gray-100">
                                                <img src={listing.image || listing.images?.[0] || 'https://via.placeholder.com/300x200'} alt={listing.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
...
export default WeitereMusikFilmeBuecherPage;
