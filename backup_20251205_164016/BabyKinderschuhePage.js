...
function BabyKinderschuhePage() {
    ...
    const resetFilters = () => {
        setCategory(''); setPriceFrom(''); setPriceTo(''); setSelectedShoeType(''); setSelectedSize('');
        setShippingOption(''); setSelectedColor(''); setSelectedCondition(''); setOfferType('');
        setProviderType(''); setDirectPurchase(''); setDeliveryService(''); setSelectedState('');
    };

    const filteredListings = listings.filter(listing =>
        listing.category === 'Familie, Kind & Baby' && listing.subCategory === 'Baby- & Kinderschuhe' &&
        ...
        (!selectedShoeType || listing.shoeType === selectedShoeType) && (!selectedSize || listing.size === selectedSize) &&
        (!shippingOption || listing.shippingOption === shippingOption) && (!selectedColor || listing.color === selectedColor) &&
        (!selectedCondition || listing.condition === selectedCondition) && (!offerType || listing.offerType === offerType) &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 48px)' }}>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-48 overflow-y-auto">
                        {[
                            { value: 'Ballerinas', count: 19988 }, { value: 'Halb- & Schnürschuhe', count: 118270 },
                            { value: 'Hausschuhe', count: 148332 }, { value: 'Sandalen', count: 109686 },
                            { value: 'Outdoor & Wanderschuhe', count: 43437 }, { value: 'Sneaker & Sportschuhe', count: 422793 },
                            { value: 'Stiefel & Stiefeletten', count: 437818 }, { value: 'Badeschuhe', count: 45231 },
                            { value: 'Weitere Schuhe', count: 40341 }
                        ].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                                    <input type="radio" name="shoeType" value={type.value} checked={selectedShoeType === type.value} onChange={(e) => setSelectedShoeType(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: '<20', count: 42912 }, { value: '20', count: 39020 }, { value: '21', count: 50515 }, { value: '22', count: 70210 },
                            { value: '23', count: 72274 }, { value: '24', count: 79490 }, { value: '25', count: 85149 }, { value: '26', count: 80843 },
                            { value: '27', count: 76907 }, { value: '28', count: 85246 }, { value: '29', count: 75602 }, { value: '30', count: 78107 },
                            { value: '31', count: 74746 }, { value: '32', count: 75574 }, { value: '33', count: 75165 }, { value: '34', count: 69306 },
                            { value: '35', count: 73385 }, { value: '36', count: 69696 }, { value: '>36', count: 113161 }
                        ].map(size => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 1208421 }, { value: 'Nur Abholung', count: 174811 }].map(shipping => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Beige', count: 22008 }, { value: 'Blau', count: 314256 }, { value: 'Braun', count: 58667 }, { value: 'Bunt', count: 38303 },
                            { value: 'Creme', count: 4581 }, { value: 'Gelb', count: 16868 }, { value: 'Gold', count: 4523 }, { value: 'Grau', count: 85642 },
                            { value: 'Grün', count: 34621 }, { value: 'Khaki', count: 7966 }, { value: 'Lavendel', count: 3663 }, { value: 'Lila', count: 41072 },
                            { value: 'Orange', count: 7629 }, { value: 'Pink', count: 88892 }, { value: 'Print', count: 1471 }, { value: 'Rot', count: 31463 },
                            { value: 'Schwarz', count: 153577 }, { value: 'Silber', count: 6962 }, { value: 'Türkis', count: 12190 }, { value: 'Weiß', count: 66166 },
                            { value: 'Andere Farben', count: 159462 }
                        ].map(color => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu mit Etikett', count: 51200 }, { value: 'Neu', count: 107987 },
                            { value: 'Sehr Gut', count: 589857 }, { value: 'Gut', count: 436605 }, { value: 'In Ordnung', count: 66917 }
                        ].map(condition => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 1386789 }, { value: 'Gesuche', count: 544 }].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 1384326 }, { value: 'Gewerblich', count: 3007 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(408.483)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 959326 }, { value: 'Hermes', count: 929320 }].map(service => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 201181 }, { value: 'Bayern', count: 291993 }, { value: 'Berlin', count: 46486 },
                            { value: 'Brandenburg', count: 35707 }, { value: 'Bremen', count: 7604 }, { value: 'Hamburg', count: 30836 },
                            { value: 'Hessen', count: 104096 }, { value: 'Mecklenburg-Vorpommern', count: 19569 }, { value: 'Niedersachsen', count: 137056 },
                            { value: 'Nordrhein-Westfalen', count: 249896 }, { value: 'Rheinland-Pfalz', count: 61684 }, { value: 'Saarland', count: 12918 },
                            { value: 'Sachsen', count: 78825 }, { value: 'Sachsen-Anhalt', count: 26755 }, { value: 'Schleswig-Holstein', count: 51916 },
                            { value: 'Thüringen', count: 30811 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <path d="M20 32 L20 42 Q20 44 22 44 L30 44 Q32 44 32 42 L32 32" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <path d="M20 32 L20 42 Q20 44 22 44 L30 44 Q32 44 32 42 L32 32" strokeWidth="2.5" strokeLinecap="round" />
                                <ellipse cx="26" cy="32" rx="8" ry="4" strokeWidth="2.5" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Baby- & Kinderschuhe</h1><p className="text-white text-lg opacity-90">Baby- & Kinderschuhe</p></div>
                    </div>
