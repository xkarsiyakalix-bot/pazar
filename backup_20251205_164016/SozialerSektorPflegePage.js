...
function SozialerSektorPflegePage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Jobs' && listing.subCategory === 'Sozialer Sektor & Pflege' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <div className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                            <span>Sozialer Sektor & Pflege</span>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Altenpfleger/-in', count: 26188 },
                            { value: 'Arzthelfer/-in', count: 2253 },
                            { value: 'Erzieher/-in', count: 4047 },
                            { value: 'Krankenpfleger/-in', count: 12410 },
                            { value: 'Physiotherapeut/-in', count: 1809 },
                            { value: 'Weitere Berufe', count: 25462 }
                        ].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Vollzeit', count: 15371 }, { value: 'Teilzeit', count: 6595 }].map(time => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 67748 }, { value: 'Gesuche', count: 4427 }].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 4423 }, { value: 'Gewerblich', count: 67752 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 8160 }, { value: 'Bayern', count: 7651 }, { value: 'Berlin', count: 5762 },
                            { value: 'Brandenburg', count: 3196 }, { value: 'Bremen', count: 898 }, { value: 'Hamburg', count: 2460 },
                            { value: 'Hessen', count: 4612 }, { value: 'Mecklenburg-Vorpommern', count: 1358 }, { value: 'Niedersachsen', count: 8549 },
                            { value: 'Nordrhein-Westfalen', count: 14899 }, { value: 'Rheinland-Pfalz', count: 2582 }, { value: 'Saarland', count: 655 },
                            { value: 'Sachsen', count: 3027 }, { value: 'Sachsen-Anhalt', count: 1645 }, { value: 'Schleswig-Holstein', count: 4692 },
                            { value: 'Thüringen', count: 2029 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <path d="M32 20 L32 28 M28 24 L36 24" strokeWidth="2.5" strokeLinecap="round" />
                                <circle cx="32" cy="32" r="12" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <circle cx="32" cy="32" r="12" strokeWidth="2.5" />
                                <path d="M26 36 L38 36" strokeWidth="2" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Sozialer Sektor & Pflege</h1><p className="text-white text-lg opacity-90">Sozialer Sektor & Pflege</p></div>
                    </div>
