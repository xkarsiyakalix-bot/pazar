            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">                <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Angebote', count: 25425 },
                            { value: 'Gesuche', count: 204 }
                        ].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Privat', count: 23777 },
                            { value: 'Gewerblich', count: 1852 }
                        ].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 2706 },
                            { value: 'Bayern', count: 5168 },
                            { value: 'Berlin', count: 66 },
                            { value: 'Brandenburg', count: 1174 },
                            { value: 'Bremen', count: 33 },
                            { value: 'Hamburg', count: 61 },
                            { value: 'Hessen', count: 1775 },
                            { value: 'Mecklenburg-Vorpommern', count: 1102 },
                            { value: 'Niedersachsen', count: 3741 },
                            { value: 'Nordrhein-Westfalen', count: 3473 },
                            { value: 'Rheinland-Pfalz', count: 1120 },
                            { value: 'Saarland', count: 211 },
                            { value: 'Sachsen', count: 1780 },
                            { value: 'Sachsen-Anhalt', count: 1011 },
                            { value: 'Schleswig-Holstein', count: 1056 },
                            { value: 'Thüringen', count: 1152 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="20" y="26" width="24" height="12" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Nutztiere</h1><p className="text-white text-lg opacity-90">Nutztiere</p></div>
                    </div>
