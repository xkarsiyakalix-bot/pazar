...
function BueroarbeitVerwaltungPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Jobs' && listing.subCategory === 'Büroarbeit & Verwaltung' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <div className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                            <span>Büroarbeit & Verwaltung</span>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Buchhalter/-in', count: 2208 },
                            { value: 'Bürokaufmann/-frau', count: 3116 },
                            { value: 'Sachbearbeiter/-in', count: 3139 },
                            { value: 'Sekretär/-in', count: 763 },
                            { value: 'Weitere Berufe', count: 12887 }
                        ].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Vollzeit', count: 10557 }, { value: 'Teilzeit', count: 2396 }].map(time => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 19922 }, { value: 'Gesuche', count: 2197 }].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 2196 }, { value: 'Gewerblich', count: 19923 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 2200 }, { value: 'Bayern', count: 3205 }, { value: 'Berlin', count: 941 },
                            { value: 'Brandenburg', count: 743 }, { value: 'Bremen', count: 325 }, { value: 'Hamburg', count: 664 },
                            { value: 'Hessen', count: 1391 }, { value: 'Mecklenburg-Vorpommern', count: 434 }, { value: 'Niedersachsen', count: 2236 },
                            { value: 'Nordrhein-Westfalen', count: 5966 }, { value: 'Rheinland-Pfalz', count: 994 }, { value: 'Saarland', count: 241 },
                            { value: 'Sachsen', count: 712 }, { value: 'Sachsen-Anhalt', count: 687 }, { value: 'Schleswig-Holstein', count: 884 },
                            { value: 'Thüringen', count: 496 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                ...
                                <rect x="24" y="22" width="16" height="20" strokeWidth="2.5" rx="2" />
                                <path d="M28 28 L36 28 M28 32 L36 32 M28 36 L36 36" strokeWidth="2" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Büroarbeit & Verwaltung</h1><p className="text-white text-lg opacity-90">Büroarbeit & Verwaltung</p></div>
                    </div>
