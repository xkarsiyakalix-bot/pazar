...
function FachbuecherSchuleStudiumPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Musik, Filme & Bücher' && listing.subCategory === 'Fachbücher, Schule & Studium' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <div className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                            <span>Fachbücher, Schule & Studium</span>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 436413 }, { value: 'Nur Abholung', count: 46359 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 70110 },
                            { value: 'Sehr Gut', count: 214354 },
                            { value: 'Gut', count: 103658 },
                            { value: 'In Ordnung', count: 18712 }
                        ].map(z => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 486089 }, { value: 'Gesuche', count: 718 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 485813 }, { value: 'Gewerblich', count: 994 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(144.346)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 289466 }, { value: 'Hermes', count: 283096 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 54525 }, { value: 'Bayern', count: 83180 }, { value: 'Berlin', count: 22982 },
                            { value: 'Brandenburg', count: 11454 }, { value: 'Bremen', count: 2577 }, { value: 'Hamburg', count: 9864 },
                            { value: 'Hessen', count: 38236 }, { value: 'Mecklenburg-Vorpommern', count: 5566 }, { value: 'Niedersachsen', count: 58036 },
                            { value: 'Nordrhein-Westfalen', count: 94742 }, { value: 'Rheinland-Pfalz', count: 47193 }, { value: 'Saarland', count: 6177 },
                            { value: 'Sachsen', count: 19787 }, { value: 'Sachsen-Anhalt', count: 8473 }, { value: 'Schleswig-Holstein', count: 14279 },
                            { value: 'Thüringen', count: 9736 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                ...
                                <path d="M26 26 L38 26 M26 32 L38 32 M26 38 L34 38" strokeWidth="2.5" strokeLinecap="round" />
                                <circle cx="32" cy="24" r="2" fill="currentColor" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Fachbücher, Schule & Studium</h1><p className="text-white text-lg opacity-90">Fachbücher, Schule & Studium</p></div>
                    </div>
