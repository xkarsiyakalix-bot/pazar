...
function BabyKinderkleidungPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Familie, Kind & Baby' &&
        listing.subCategory === 'Baby- & Kinderkleidung' &&
        ...
        (!selectedClothingType || listing.clothingType === selectedClothingType) &&
        (!selectedSize || listing.size === selectedSize) &&
        (!selectedGender || listing.gender === selectedGender) &&
        (!shippingOption || listing.shippingOption === shippingOption) &&
        (!selectedColor || listing.color === selectedColor) &&
        ...
        (!directPurchase || listing.directPurchase === directPurchase) &&
        (!deliveryService || listing.deliveryService === deliveryService) &&
    ...
    return (
        <div className="min-h-screen bg-gray-50"><div className="max-w-[1400px] mx-auto px-4 py-6"><div className="flex gap-6">
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 48px)' }}>
                ...
                {/* Art (Clothing Type) Filter */}
                <div className="mb-6">
                    <h4 className="font-bold text-gray-900 mb-3 text-base">Art</h4>
                    <div className="space-y-2 max-h-48 overflow-y-auto">
                        {[
                            { value: 'Hosen & Jeans', count: 871676 },
                            { value: 'Kleider & Röcke', count: 379815 },
                            { value: 'Shirts & Tops', count: 785878 },
                            { value: 'Hemden', count: 82475 },
                            { value: 'Jacken & Mäntel', count: 1155125 },
                            { value: 'Pullover & Strickjacken', count: 539180 },
                            { value: 'Wäsche', count: 287814 },
                            { value: 'Sportbekleidung', count: 123144 },
                            { value: 'Bademode', count: 92381 },
                            { value: 'Accessoires', count: 234433 },
                            { value: 'Kleidungspakete', count: 372511 },
                            { value: 'Weitere Baby- & Kinderkleidung', count: 201848 }
                        ].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                                    <input type="radio" name="clothingType" value={type.value} checked={selectedClothingType === type.value} onChange={(e) => setSelectedClothingType(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                ...
                {/* Größe (Size) Filter */}
                <div className="mb-6">
                    <h4 className="font-bold text-gray-900 mb-3 text-base">Größe</h4>
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: '44', count: 24327 }, { value: '50', count: 81829 }, { value: '56', count: 117922 }, { value: '62', count: 227935 },
                            { value: '68', count: 200451 }, { value: '74', count: 283668 }, { value: '80', count: 219036 }, { value: '86', count: 329182 },
                            { value: '92', count: 282029 }, { value: '98', count: 345901 }, { value: '104', count: 279782 }, { value: '110', count: 319126 },
                            { value: '116', count: 279354 }, { value: '122', count: 297617 }, { value: '128', count: 306844 }, { value: '134', count: 256595 },
                            { value: '140', count: 283426 }, { value: '146', count: 221925 }, { value: '152', count: 284287 }, { value: '158', count: 172660 },
                            { value: '164', count: 194428 }, { value: '170', count: 59193 }, { value: '176', count: 55641 }, { value: '182', count: 3881 },
                            { value: '188', count: 5498 }
                        ].map(size => (
                            <label key={size.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                                    <input type="radio" name="size" value={size.value} checked={selectedSize === size.value} onChange={(e) => setSelectedSize(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                                    <span className="ml-2 text-sm text-gray-700">{size.value}</span>
                                </div>
                                <span className="text-xs text-gray-500">({size.count.toLocaleString('de-DE')})</span>
                            </label>
                        ))}
                    </div>
                </div>

                {/* Mädchen & Jungen Filter */}
                <div className="mb-6">
                    <h4 className="font-bold text-gray-900 mb-3 text-base">Mädchen & Jungen</h4>
                    <div className="space-y-2">
                        {[
                            { value: 'Jungen', count: 1359146 },
                            { value: 'Mädchen', count: 2283854 },
                            { value: 'Unisex', count: 1483716 }
                        ].map(gender => (
                            <label key={gender.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                                    <input type="radio" name="gender" value={gender.value} checked={selectedGender === gender.value} onChange={(e) => setSelectedGender(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                                    <span className="ml-2 text-sm text-gray-700">{gender.value}</span>
                                </div>
                                <span className="text-xs text-gray-500">({gender.count.toLocaleString('de-DE')})</span>
                            </label>
                        ))}
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Versand möglich', count: 4639267 },
                            { value: 'Nur Abholung', count: 467460 }
                        ].map(shipping => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Beige', count: 92607 }, { value: 'Blau', count: 1031796 }, { value: 'Braun', count: 75055 }, { value: 'Bunt', count: 317087 },
                            { value: 'Creme', count: 34045 }, { value: 'Gelb', count: 55867 }, { value: 'Gold', count: 3166 }, { value: 'Grau', count: 309597 },
                            { value: 'Grün', count: 138080 }, { value: 'Khaki', count: 46268 }, { value: 'Lavendel', count: 9505 }, { value: 'Lila', count: 71967 },
                            { value: 'Orange', count: 35339 }, { value: 'Pink', count: 230937 }, { value: 'Print', count: 12007 }, { value: 'Rot', count: 147054 },
                            { value: 'Schwarz', count: 274798 }, { value: 'Silber', count: 4219 }, { value: 'Türkis', count: 48565 }, { value: 'Weiß', count: 195529 },
                            { value: 'Andere Farben', count: 917432 }
                        ].map(color => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu mit Etikett', count: 139240 },
                            { value: 'Neu', count: 349064 },
                            { value: 'Sehr Gut', count: 3016667 },
                            { value: 'Gut', count: 913358 },
                            { value: 'In Ordnung', count: 76365 }
                        ].map(condition => (
                            <label key={condition.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                                    <input type="radio" name="condition" value={condition.value} checked={selectedCondition === condition.value} onChange={(e) => setSelectedCondition(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                                    <span className="ml-2 text-sm text-gray-700">{condition.value}</span>
                                </div>
                                <span className="text-xs text-gray-500">({condition.count.toLocaleString('de-DE')})</span>
                            </label>
                        ))}
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Angebote', count: 5130063 },
                            { value: 'Gesuche', count: 2578 }
                        ].map(type => (
                            <label key={type.value} className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                <div className="flex items-center">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Privat', count: 5124834 },
                            { value: 'Gewerblich', count: 7807 }
                        ].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(1.366.252)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'DHL', count: 3260613 },
                            { value: 'Hermes', count: 3186737 }
                        ].map(service => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto">
                        {[
                            { value: 'Baden-Württemberg', count: 646880 },
                            { value: 'Bayern', count: 979808 },
                            { value: 'Berlin', count: 172223 },
                            { value: 'Brandenburg', count: 161265 },
                            { value: 'Bremen', count: 28365 },
                            { value: 'Hamburg', count: 111978 },
                            { value: 'Hessen', count: 390436 },
                            { value: 'Mecklenburg-Vorpommern', count: 92937 },
                            { value: 'Niedersachsen', count: 539697 },
                            { value: 'Nordrhein-Westfalen', count: 978134 },
                            { value: 'Rheinland-Pfalz', count: 225855 },
                            { value: 'Saarland', count: 48967 },
                            { value: 'Sachsen', count: 307581 },
                            { value: 'Sachsen-Anhalt', count: 114155 },
                            { value: 'Schleswig-Holstein', count: 207091 },
                            { value: 'Thüringen', count: 127269 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <rect x="24" y="22" width="16" height="20" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2" />
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Baby- & Kinderkleidung</h1><p className="text-white text-lg opacity-90">Baby- & Kinderkleidung</p></div>
                    </div>
