...
function DienstleistungenTierbetreuungPage() {
                ...
                <div className="flex gap-6">
                    <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(5.898)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(2.428)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(5.789)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(2.537)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                {[
                                    { value: 'Baden-Württemberg', count: 971 },
                                    { value: 'Bayern', count: 1472 },
                                    { value: 'Berlin', count: 197 },
                                    { value: 'Brandenburg', count: 307 },
                                    { value: 'Bremen', count: 45 },
                                    { value: 'Hamburg', count: 173 },
                                    { value: 'Hessen', count: 646 },
                                    { value: 'Mecklenburg-Vorpommern', count: 195 },
                                    { value: 'Niedersachsen', count: 1160 },
                                    { value: 'Nordrhein-Westfalen', count: 1569 },
                                    { value: 'Rheinland-Pfalz', count: 398 },
                                    { value: 'Saarland', count: 67 },
                                    { value: 'Sachsen', count: 301 },
                                    { value: 'Sachsen-Anhalt', count: 144 },
                                    { value: 'Schleswig-Holstein', count: 546 },
                                    { value: 'Thüringen', count: 135 }
                                ].map(state => (
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 className="text-4xl font-bold text-white mb-1">Tierbetreuung & Training</h1>
                                            <p className="text-white text-lg opacity-90">Tierbetreuung & Training Dienstleistungen</p>
                                        </div>
                                    </div>
