...
function EsoterikSpirituellesPage() {
    ...
    const resetFilters = () => {
        ...
        setOfferType(''); setProviderType(''); setPaketdienst(''); setSelectedState('');
    };

    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Esoterik & Spirituelles' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 26132 }, { value: 'Nur Abholung', count: 2904 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 8506 },
                            { value: 'Sehr Gut', count: 11358 },
                            { value: 'Gut', count: 2760 },
                            { value: 'In Ordnung', count: 294 }
                        ].map(z => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 29032 }, { value: 'Gesuche', count: 79 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 27078 }, { value: 'Gewerblich', count: 2033 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 15124 }, { value: 'Hermes', count: 15245 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 3723 }, { value: 'Bayern', count: 6234 }, { value: 'Berlin', count: 1360 },
                            { value: 'Brandenburg', count: 571 }, { value: 'Bremen', count: 231 }, { value: 'Hamburg', count: 827 },
                            { value: 'Hessen', count: 2290 }, { value: 'Mecklenburg-Vorpommern', count: 485 }, { value: 'Niedersachsen', count: 2472 },
                            { value: 'Nordrhein-Westfalen', count: 5657 }, { value: 'Rheinland-Pfalz', count: 1504 }, { value: 'Saarland', count: 371 },
                            { value: 'Sachsen', count: 947 }, { value: 'Sachsen-Anhalt', count: 362 }, { value: 'Schleswig-Holstein', count: 1610 },
                            { value: 'Thüringen', count: 467 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                ...
                                <path d="M32 18 L32 22 M32 42 L32 46 M18 32 L22 32 M42 32 L46 32" strokeWidth="2.5" strokeLinecap="round" />
                                <path d="M23 23 L26 26 M38 38 L41 41 M41 23 L38 26 M26 38 L23 41" strokeWidth="2.5" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Esoterik & Spirituelles</h1><p className="text-white text-lg opacity-90">Esoterik & Spirituelles</p></div>
                    </div>
...
export default EsoterikSpirituellesPage;
