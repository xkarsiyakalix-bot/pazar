...
function WeitereEintrittskartenTicketsPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Eintrittskarten & Tickets' &&
        listing.subCategory === 'Weitere Eintrittskarten & Tickets' &&
                    ...
                    <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                        <div className="mb-6 pb-6 border-b border-gray-200">
                            ...
                            <div className="space-y-2 mt-3">
                                ...
                                <div className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                                    <span>Weitere Eintrittskarten & Tickets</span>
                                    <div onClick={(e) => { e.stopPropagation(); navigate('/Eintrittskarten-Tickets'); }} className="text-white hover:text-red-200 transition-colors cursor-pointer" title="Kategorie schließen">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                        <input type="radio" name="versand" value="Versand möglich" checked={versand === 'Versand möglich'} onChange={(e) => setVersand(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                                        <span className="ml-2 text-sm text-gray-700">Versand möglich</span>
                                    </div>
                                    <span className="text-xs text-gray-500">(8.796)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                        <input type="radio" name="versand" value="Nur Abholung" checked={versand === 'Nur Abholung'} onChange={(e) => setVersand(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                                        <span className="ml-2 text-sm text-gray-700">Nur Abholung</span>
                                    </div>
                                    <span className="text-xs text-gray-500">(2.138)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(7.969)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(2.983)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    ...
                                    <span className="text-xs text-gray-500">(10.685)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                    ...
                                    <span className="text-xs text-gray-500">(267)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                        <input type="radio" name="paketdienst" value="DHL" checked={paketdienst === 'DHL'} onChange={(e) => setPaketdienst(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                                        <span className="ml-2 text-sm text-gray-700">DHL</span>
                                    </div>
                                    <span className="text-xs text-gray-500">(4.861)</span>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                                    <div className="flex items-center">
                                        <input type="radio" name="paketdienst" value="Hermes" checked={paketdienst === 'Hermes'} onChange={(e) => setPaketdienst(e.target.value)} className="w-4 h-4 text-red-600 focus:ring-red-500" />
                                        <span className="ml-2 text-sm text-gray-700">Hermes</span>
                                    </div>
                                    <span className="text-xs text-gray-500">(4.792)</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-2">
                                {[
                                    { value: 'Baden-Württemberg', count: 1374 },
                                    { value: 'Bayern', count: 1384 },
                                    { value: 'Berlin', count: 644 },
                                    { value: 'Brandenburg', count: 251 },
                                    { value: 'Bremen', count: 103 },
                                    { value: 'Hamburg', count: 376 },
                                    { value: 'Hessen', count: 689 },
                                    { value: 'Mecklenburg-Vorpommern', count: 137 },
                                    { value: 'Niedersachsen', count: 1114 },
                                    { value: 'Nordrhein-Westfalen', count: 3095 },
                                    { value: 'Rheinland-Pfalz', count: 439 },
                                    { value: 'Saarland', count: 164 },
                                    { value: 'Sachsen', count: 416 },
                                    { value: 'Sachsen-Anhalt', count: 153 },
                                    { value: 'Schleswig-Holstein', count: 460 },
                                    { value: 'Thüringen', count: 153 }
                                ].map(state => (
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                                ...
                                                <path d="M26 26 Q32 30 38 26" strokeWidth="2" strokeLinecap="round" />
                                            </svg>
                                        </div>
                                        <div>
                                            <h1 className="text-4xl font-bold text-white mb-1">Weitere Eintrittskarten & Tickets</h1>
                                            <p className="text-white text-lg opacity-90">Weitere Eintrittskarten & Tickets</p>
                                        </div>
                                    </div>
