...
function EssenTrinkenPage() {
    ...
    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Essen & Trinken' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 52181 }, { value: 'Nur Abholung', count: 19880 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Neu', count: 28519 },
                            { value: 'Sehr Gut', count: 20446 },
                            { value: 'Gut', count: 7030 },
                            { value: 'In Ordnung', count: 987 }
                        ].map(z => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 72412 }, { value: 'Gesuche', count: 515 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 68398 }, { value: 'Gewerblich', count: 4529 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(15.564)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 34478 }, { value: 'Hermes', count: 33691 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 9990 }, { value: 'Bayern', count: 13743 }, { value: 'Berlin', count: 2291 },
                            { value: 'Brandenburg', count: 1898 }, { value: 'Bremen', count: 374 }, { value: 'Hamburg', count: 1588 },
                            { value: 'Hessen', count: 5993 }, { value: 'Mecklenburg-Vorpommern', count: 1113 }, { value: 'Niedersachsen', count: 7465 },
                            { value: 'Nordrhein-Westfalen', count: 14594 }, { value: 'Rheinland-Pfalz', count: 4037 }, { value: 'Saarland', count: 1047 },
                            { value: 'Sachsen', count: 3320 }, { value: 'Sachsen-Anhalt', count: 1372 }, { value: 'Schleswig-Holstein', count: 2514 },
                            { value: 'Thüringen', count: 1588 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <path d="M32 16 L32 48" strokeWidth="2.5" strokeLinecap="round" />
                                <circle cx="32" cy="28" r="8" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <circle cx="32" cy="28" r="8" strokeWidth="2.5" />
                                <path d="M24 36 L40 36 L38 44 L26 44 Z" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Essen & Trinken</h1><p className="text-white text-lg opacity-90">Essen & Trinken</p></div>
                    </div>
