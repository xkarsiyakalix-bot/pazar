...
function LampenLichtPage() {
    ...
    const filteredListings = listings.filter(listing =>
        ...
        listing.subCategory === 'Lampen & Licht' &&
        ...
        <div className="min-h-screen bg-gray-50"><div className="max-w-[1400px] mx-auto px-4 py-6"><div className="flex gap-6">
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Versand</h4><div className="space-y-2">
                    {[{ value: 'Versand möglich', label: 'Versand möglich', count: '369.622' }, { value: 'Nur Abholung', label: 'Nur Abholung', count: '248.355' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Farbe</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Beige', label: 'Beige', count: '15.441' }, { value: 'Blau', label: 'Blau', count: '11.065' }, { value: 'Braun', label: 'Braun', count: '17.883' }, { value: 'Bunt', label: 'Bunt', count: '13.665' }, { value: 'Burgunderrot', label: 'Burgunderrot', count: '459' }, { value: 'Gelb', label: 'Gelb', count: '5.409' }, { value: 'Gold', label: 'Gold', count: '23.963' }, { value: 'Grau', label: 'Grau', count: '20.781' }, { value: 'Grün', label: 'Grün', count: '7.604' }, { value: 'Holz', label: 'Holz', count: '8.772' }, { value: 'Khaki', label: 'Khaki', count: '112' }, { value: 'Lila', label: 'Lila', count: '1.596' }, { value: 'Orange', label: 'Orange', count: '4.216' }, { value: 'Rosa', label: 'Rosa', count: '6.495' }, { value: 'Rot', label: 'Rot', count: '6.870' }, { value: 'Schwarz', label: 'Schwarz', count: '55.571' }, { value: 'Silber', label: 'Silber', count: '66.657' }, { value: 'Transparent', label: 'Transparent', count: '10.400' }, { value: 'Weiß', label: 'Weiß', count: '100.216' }, { value: 'Andere Farben', label: 'Andere Farben', count: '67.992' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Material</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Bronze', label: 'Bronze', count: '2.243' }, { value: 'Eiche', label: 'Eiche', count: '1.025' }, { value: 'Eisen', label: 'Eisen', count: '8.973' }, { value: 'Glas', label: 'Glas', count: '68.400' }, { value: 'Holz', label: 'Holz', count: '21.962' }, { value: 'Keramik', label: 'Keramik', count: '7.683' }, { value: 'Kiefer', label: 'Kiefer', count: '118' }, { value: 'Korb & Rattan', label: 'Korb & Rattan', count: '1.893' }, { value: 'Kunststoff', label: 'Kunststoff', count: '46.942' }, { value: 'Lackiert', label: 'Lackiert', count: '1.161' }, { value: 'Leder', label: 'Leder', count: '601' }, { value: 'Marmor', label: 'Marmor', count: '1.071' }, { value: 'Massivholz', label: 'Massivholz', count: '685' }, { value: 'Metall', label: 'Metall', count: '108.401' }, { value: 'Samt', label: 'Samt', count: '481' }, { value: 'Schichtstoff', label: 'Schichtstoff', count: '385' }, { value: 'Stahl', label: 'Stahl', count: '6.436' }, { value: 'Stein', label: 'Stein', count: '1.334' }, { value: 'Stoff', label: 'Stoff', count: '8.696' }, { value: 'Sonstige', label: 'Sonstige', count: '72.381' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Zustand</h4><div className="space-y-2">
                    {[{ value: 'Neu', label: 'Neu', count: '102.180' }, { value: 'Sehr Gut', label: 'Sehr Gut', count: '290.392' }, { value: 'Gut', label: 'Gut', count: '110.997' }, { value: 'In Ordnung', label: 'In Ordnung', count: '15.269' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Angebotstyp</h4><div className="space-y-2">
                    {[{ value: 'Angebote', label: 'Angebote', count: '618.523' }, { value: 'Gesuche', label: 'Gesuche', count: '1.235' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Anbieter</h4><div className="space-y-2">
                    {[{ value: 'Privat', label: 'Privat', count: '600.017' }, { value: 'Gewerblich', label: 'Gewerblich', count: '19.741' }].map(option => (
                ...
                <div className="mb-6 pb-6 border-b border-gray-200"><h4 className="font-bold text-gray-900 mb-3 text-base">Paketdienst</h4><div className="space-y-2">
                    {[{ value: 'DHL', label: 'DHL', count: '287.546' }, { value: 'Hermes', label: 'Hermes', count: '266.462' }].map(option => (
                ...
                <div className="mb-6"><h4 className="font-bold text-gray-900 mb-3 text-base">Ort</h4><div className="space-y-2 max-h-64 overflow-y-auto">
                    {[{ value: 'Baden-Württemberg', label: 'Baden-Württemberg', count: '71.308' }, { value: 'Bayern', label: 'Bayern', count: '99.737' }, { value: 'Berlin', label: 'Berlin', count: '30.311' }, { value: 'Brandenburg', label: 'Brandenburg', count: '16.715' }, { value: 'Bremen', label: 'Bremen', count: '4.601' }, { value: 'Hamburg', label: 'Hamburg', count: '18.807' }, { value: 'Hessen', label: 'Hessen', count: '46.527' }, { value: 'Mecklenburg-Vorpommern', label: 'Mecklenburg-Vorpommern', count: '8.574' }, { value: 'Niedersachsen', label: 'Niedersachsen', count: '68.746' }, { value: 'Nordrhein-Westfalen', label: 'Nordrhein-Westfalen', count: '138.871' }, { value: 'Rheinland-Pfalz', label: 'Rheinland-Pfalz', count: '28.950' }, { value: 'Saarland', label: 'Saarland', count: '7.896' }, { value: 'Sachsen', label: 'Sachsen', count: '29.070' }, { value: 'Sachsen-Anhalt', label: 'Sachsen-Anhalt', count: '11.478' }, { value: 'Schleswig-Holstein', label: 'Schleswig-Holstein', count: '26.840' }, { value: 'Thüringen', label: 'Thüringen', count: '11.327' }].map(option => (
            ...
            <div className="flex-1">
                <div className="bg-red-600 rounded-2xl shadow-xl p-8 mb-6 relative overflow-hidden"><div className="absolute inset-0 opacity-10"><div className="absolute top-0 left-0 w-full h-full" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(255,255,255,.1) 35px, rgba(255,255,255,.1) 70px)' }}></div></div>
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        ...
                        <div><h1 className="text-4xl font-bold text-white mb-1">Lampen & Licht</h1><p className="text-white text-lg opacity-90">Beleuchtung für Ihr Zuhause</p></div>
                    </div>
