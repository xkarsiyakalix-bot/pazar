...
function HandarbeitBastelnKunsthandwerkPage() {
    ...
    const resetFilters = () => {
        setPriceFrom(''); setPriceTo(''); setVersand(''); setOfferType('');
        setProviderType(''); setDirektKaufen(''); setPaketdienst(''); setSelectedState('');
    };

    const filteredListings = listings.filter(listing =>
        listing.category === 'Freizeit, Hobby & Nachbarschaft' && listing.subCategory === 'Handarbeit, Basteln & Kunsthandwerk' &&
            ...
            <aside className="w-96 flex-shrink-0 bg-white rounded-2xl shadow-lg p-6 h-fit sticky top-6">
                <div className="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div className="space-y-2 mt-3">
                        ...
                        <div className="text-left px-3 py-2 rounded-lg text-sm transition-all bg-red-600 text-white shadow-md flex items-center justify-between ml-8" style={{ width: 'calc(100% - 2rem)' }}>
                            <span>Handarbeit, Basteln & Kunsthandwerk</span>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Versand möglich', count: 427038 }, { value: 'Nur Abholung', count: 67375 }].map(v => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Angebote', count: 494068 }, { value: 'Gesuche', count: 2531 }].map(type => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'Privat', count: 483910 }, { value: 'Gewerblich', count: 12689 }].map(provider => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2 rounded-lg transition-colors">
                            ...
                            <span className="text-xs text-gray-500">(110.862)</span>
                        </label>
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[{ value: 'DHL', count: 262816 }, { value: 'Hermes', count: 261539 }].map(p => (
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-2">
                        {[
                            { value: 'Baden-Württemberg', count: 59362 }, { value: 'Bayern', count: 83051 }, { value: 'Berlin', count: 18397 },
                            { value: 'Brandenburg', count: 15107 }, { value: 'Bremen', count: 3560 }, { value: 'Hamburg', count: 11292 },
                            { value: 'Hessen', count: 35981 }, { value: 'Mecklenburg-Vorpommern', count: 7846 }, { value: 'Niedersachsen', count: 55525 },
                            { value: 'Nordrhein-Westfalen', count: 95915 }, { value: 'Rheinland-Pfalz', count: 23709 }, { value: 'Saarland', count: 4785 },
                            { value: 'Sachsen', count: 37198 }, { value: 'Sachsen-Anhalt', count: 9330 }, { value: 'Schleswig-Holstein', count: 24256 },
                            { value: 'Thüringen', count: 11285 }
                        ].map(state => (
                    ...
                    <div className="relative z-10"><div className="flex items-center justify-between"><div className="flex items-center gap-4">
                        <div className="w-16 h-16 bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                            <svg className="w-10 h-10 text-white" viewBox="0 0 64 64" fill="none" stroke="currentColor">
                                <path d="M20 20 L44 20 L44 44 L20 44 Z" strokeWidth="2.5" fill="currentColor" opacity="0.3" />
                                <path d="M20 20 L44 20 L44 44 L20 44 Z" strokeWidth="2.5" />
                                <path d="M28 28 L36 28 M28 32 L36 32 M28 36 L36 36" strokeWidth="2" strokeLinecap="round" />
                            </svg>
                        </div>
                        <div><h1 className="text-4xl font-bold text-white mb-1">Handarbeit, Basteln & Kunsthandwerk</h1><p className="text-white text-lg opacity-90">Handarbeit, Basteln & Kunsthandwerk</p></div>
                    </div>
                        ...
                        <div className="space-y-4">{filteredListings.map((listing) => (
                            <div key={listing.id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer group overflow-hidden flex" onClick={() => navigate(`/product/${listing.id}`)}><div className="relative w-64 h-48 flex-shrink-0 bg-gray-100"><img src={listing.image || listing.images?.[0] || 'https://via.placeholder.com/300x200'} alt={listing.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
                                ...
                                <div className="flex-1 p-6 flex flex-col justify-between">
                                    <h3 className="font-semibold text-lg text-gray-900 mb-2 group-hover:text-red-600 transition-colors line-clamp-2">{listing.title}</h3>
                                    <p className="text-xl font-bold text-red-600 mb-2">{typeof listing.price === 'string' ? listing.price : listing.price ? `${listing.price.toLocaleString('de-DE')} €` : 'VB'}</p>
