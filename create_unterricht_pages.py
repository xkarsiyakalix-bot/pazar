#!/usr/bin/env python3
"""Script to create Unterricht & Kurse subcategory pages"""

subcategories = [
    {'name': 'Beauty & Gesundheit', 'filename': 'UnterrichtBeautyGesundheitPage.js', 'route': 'beauty-gesundheit', 'icon': '''<circle cx="32" cy="28" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="32" cy="28" r="6" strokeWidth="2.5"/><path d="M26 36 Q32 40 38 36" strokeWidth="2" strokeLinecap="round"/>''', 'description': 'Beauty & Gesundheit Kurse'},
    {'name': 'Computerkurse', 'filename': 'ComputerkursePage.js', 'route': 'computerkurse', 'icon': '''<rect x="20" y="24" width="24" height="16" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/><rect x="20" y="24" width="24" height="16" strokeWidth="2.5" rx="2"/><rect x="26" y="42" width="12" height="2" strokeWidth="2" fill="currentColor"/>''', 'description': 'Computerkurse'},
    {'name': 'Esoterik & Spirituelles', 'filename': 'UnterrichtEsoterikPage.js', 'route': 'esoterik-spirituelles', 'icon': '''<circle cx="32" cy="32" r="8" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="32" cy="32" r="8" strokeWidth="2.5"/><path d="M32 24 L32 20 M32 44 L32 40 M24 32 L20 32 M44 32 L40 32" strokeWidth="2" strokeLinecap="round"/>''', 'description': 'Esoterik & Spirituelles'},
    {'name': 'Kochen & Backen', 'filename': 'KochenBackenPage.js', 'route': 'kochen-backen', 'icon': '''<circle cx="32" cy="30" r="8" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="32" cy="30" r="8" strokeWidth="2.5"/><path d="M26 38 L26 42 M32 38 L32 42 M38 38 L38 42" strokeWidth="2.5" strokeLinecap="round"/>''', 'description': 'Kochen & Backen Kurse'},
    {'name': 'Kunst & Gestaltung', 'filename': 'KunstGestaltungPage.js', 'route': 'kunst-gestaltung', 'icon': '''<rect x="22" y="22" width="20" height="20" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/><rect x="22" y="22" width="20" height="20" strokeWidth="2.5" rx="2"/><path d="M28 28 L36 36 M28 36 L36 28" strokeWidth="2" strokeLinecap="round"/>''', 'description': 'Kunst & Gestaltung'},
    {'name': 'Musik & Gesang', 'filename': 'MusikGesangPage.js', 'route': 'musik-gesang', 'icon': '''<circle cx="28" cy="32" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="28" cy="32" r="6" strokeWidth="2.5"/><path d="M34 24 L34 36 L38 38" strokeWidth="2.5" strokeLinecap="round"/>''', 'description': 'Musik & Gesang Unterricht'},
    {'name': 'Nachhilfe', 'filename': 'NachhilfePage.js', 'route': 'nachhilfe', 'icon': '''<rect x="22" y="20" width="20" height="24" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/><rect x="22" y="20" width="20" height="24" strokeWidth="2.5" rx="2"/><path d="M26 26 L38 26 M26 30 L38 30 M26 34 L34 34" strokeWidth="2" strokeLinecap="round"/>''', 'description': 'Nachhilfe'},
    {'name': 'Sportkurse', 'filename': 'SportkursePage.js', 'route': 'sportkurse', 'icon': '''<circle cx="32" cy="26" r="4" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="32" cy="26" r="4" strokeWidth="2.5"/><path d="M26 32 L26 42 M32 32 L32 42 M38 32 L38 42" strokeWidth="2.5" strokeLinecap="round"/>''', 'description': 'Sportkurse'},
    {'name': 'Sprachkurse', 'filename': 'SprachkursePage.js', 'route': 'sprachkurse', 'icon': '''<circle cx="28" cy="28" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="28" cy="28" r="6" strokeWidth="2.5"/><circle cx="38" cy="32" r="5" strokeWidth="2" fill="none"/><path d="M24 34 Q28 38 32 34" strokeWidth="2" strokeLinecap="round"/>''', 'description': 'Sprachkurse'},
    {'name': 'Tanzkurse', 'filename': 'TanzkursePage.js', 'route': 'tanzkurse', 'icon': '''<circle cx="28" cy="24" r="4" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="28" cy="24" r="4" strokeWidth="2.5"/><path d="M24 30 L24 42 M32 30 L32 38" strokeWidth="2.5" strokeLinecap="round"/><circle cx="38" cy="28" r="3" strokeWidth="2" fill="none"/>''', 'description': 'Tanzkurse'},
    {'name': 'Weiterbildung', 'filename': 'WeiterbildungPage.js', 'route': 'weiterbildung', 'icon': '''<rect x="22" y="24" width="20" height="16" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/><rect x="22" y="24" width="20" height="16" strokeWidth="2.5" rx="2"/><path d="M28 30 L32 34 L36 30" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>''', 'description': 'Weiterbildung'},
    {'name': 'Weitere Unterricht & Kurse', 'filename': 'WeitereUnterrichtKursePage.js', 'route': 'weitere-unterricht-kurse', 'icon': '''<circle cx="32" cy="32" r="10" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="32" cy="32" r="10" strokeWidth="2.5"/><path d="M28 30 L32 34 L36 30" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>''', 'description': 'Weitere Unterricht & Kurse'}
]
...
function {component_name}() {{
    ...
    const filteredListings = listings.filter(listing => listing.category === 'Unterricht & Kurse' && listing.subCategory === '{subcategory_name}');
...
print(f"\n✅ Created {len(subcategories)} Unterricht & Kurse subcategory pages!")
