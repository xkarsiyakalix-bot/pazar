#!/usr/bin/env python3
"""
Script to create Haustiere subcategory pages with horizontal layout
"""

# Define all Haustiere subcategories with their details
subcategories = [
    {
        'name': 'Fische',
        'filename': 'FischePage.js',
        'route': 'fische',
        'icon': '''<path d="M16 32 Q24 28 32 32 Q40 36 48 32" strokeWidth="2.5" fill="currentColor" opacity="0.3"/>
        ...
        'description': 'Fische & Aquaristik'
    },
    {
        'name': 'Hunde',
        'filename': 'HundePage.js',
        'route': 'hunde',
        'icon': '''<circle cx="28" cy="28" r="8" strokeWidth="2.5" fill="currentColor" opacity="0.3"/>
        ...
        'description': 'Hunde & Welpen'
    },
    {
        'name': 'Katzen',
        'filename': 'KatzenPage.js',
        'route': 'katzen',
        'icon': '''<circle cx="32" cy="30" r="8" strokeWidth="2.5" fill="currentColor" opacity="0.3"/>
        ...
        'description': 'Katzen & Kitten'
    },
    {
        'name': 'Kleintiere',
        'filename': 'KleintierePage.js',
        'route': 'kleintiere',
        'icon': '''<circle cx="30" cy="30" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3"/>
                                <circle cx="30" cy="30" r="6" strokeWidth="2.5" strokeLinecap="round"/>
                                <circle cx="28" cy="28" r="1.5" fill="currentColor"/>
                                <circle cx="32" cy="28" r="1.5" fill="currentColor"/>
                                <path d="M26 26 L22 24 M34 26 L38 24" strokeWidth="2" strokeLinecap="round"/>''',
        'description': 'Kleintiere & Nager'
    },
    {
        'name': 'Nutztiere',
        'filename': 'NutztierePage.js',
        'route': 'nutztiere',
        'icon': '''<rect x="20" y="26" width="24" height="12" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/>
                                <rect x="20" y="26" width="24" height="12" strokeWidth="2.5" strokeLinecap="round" rx="2"/>
                                <path d="M24 38 L24 44 M28 38 L28 44 M36 38 L36 44 M40 38 L40 44" strokeWidth="2.5" strokeLinecap="round"/>''',
        'description': 'Nutztiere'
    },
    {
        'name': 'Pferde',
        'filename': 'PferdePage.js',
        'route': 'pferde',
        'icon': '''<path d="M24 20 L28 16 L32 20 L32 28 L28 32 L24 28 Z" strokeWidth="2.5" fill="currentColor" opacity="0.3"/>
                                <path d="M24 20 L28 16 L32 20 L32 28 L28 32 L24 28 Z" strokeWidth="2.5" strokeLinecap="round"/>
                                <path d="M28 32 L28 44 M24 38 L32 38" strokeWidth="2.5" strokeLinecap="round"/>''',
        'description': 'Pferde & Zubehör'
    },
    {
        'name': 'Tierbetreuung & Training',
        'filename': 'TierbetreuungTrainingPage.js',
        'route': 'tierbetreuung-training',
        'icon': '''<circle cx="26" cy="28" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3"/>
                                <circle cx="26" cy="28" r="6" strokeWidth="2.5" strokeLinecap="round"/>
                                <path d="M34 24 L38 20 L42 24 L42 32 L38 36 L34 32 Z" strokeWidth="2" fill="none"/>
                                <path d="M38 28 L42 28" strokeWidth="2" strokeLinecap="round"/>''',
        'description': 'Tierbetreuung & Training'
    },
    {
        'name': 'Vermisste Tiere',
        'filename': 'VermissTierePage.js',
        'route': 'vermisste-tiere',
        'icon': '''<circle cx="32" cy="28" r="10" strokeWidth="2.5" fill="currentColor" opacity="0.3"/>
        ...
        'description': 'Vermisste Tiere'
    },
    {
        'name': 'Vögel',
        'filename': 'VoegelPage.js',
        'route': 'voegel',
        'icon': '''<path d="M20 32 Q28 24 36 32" strokeWidth="2.5" fill="currentColor" opacity="0.3"/>
                                <path d="M20 32 Q28 24 36 32" strokeWidth="2.5" strokeLinecap="round"/>
                                <circle cx="28" cy="28" r="3" strokeWidth="2" fill="none"/>
                                <path d="M28 32 L28 40 M24 36 L32 36" strokeWidth="2" strokeLinecap="round"/>''',
        'description': 'Vögel & Zubehör'
    },
    {
        'name': 'Zubehör',
        'filename': 'TierzubehoerPage.js',
        'route': 'zubehoer',
        'icon': '''<rect x="22" y="24" width="20" height="16" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/>
                                <rect x="22" y="24" width="20" height="16" strokeWidth="2.5" strokeLinecap="round" rx="2"/>
                                <circle cx="28" cy="32" r="2" fill="currentColor"/>
                                <circle cx="36" cy="32" r="2" fill="currentColor"/>''',
        'description': 'Tierzubehör'
    }
]
...
function {component_name}() {{
    ...
    const filteredListings = listings.filter(listing => listing.category === 'Haustiere' && listing.subCategory === '{subcategory_name}' && (!category || listing.category === category) && (!priceFrom || listing.price >= parseFloat(priceFrom)) && (!priceTo || listing.price <= parseFloat(priceTo)));
...
print(f"\n✅ Created {len(subcategories)} Haustiere subcategory pages!")
