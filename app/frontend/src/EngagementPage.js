    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-neutral-950 transition-colors duration-300">
            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                {/* Intro */}
                <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-lg dark:shadow-none p-8 md:p-12 mb-12">
                    <p className="text-xl text-gray-700 dark:text-neutral-400 leading-relaxed">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="flex flex-col justify-center">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-neutral-50 mb-4">Sosyal Cuma Günleri</h2>
                        <p className="text-gray-700 dark:text-neutral-400 leading-relaxed mb-4">
                        ...
                        <div className="bg-red-50 dark:bg-red-900/10 p-6 rounded-xl">
                            ...
                            <p className="text-gray-700 dark:text-neutral-400">Ekibimiz sadece 2022'nin ikinci yarısında istasyon misyonunda bu kadar saat yardımda bulundu.</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Kinder.Akademie */}
                <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-lg dark:shadow-none p-8 md:p-12 mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-neutral-50 mb-6">Çocuk Akademisi – sosyal konular çocuklar için uygun şekilde paketlendi</h2>
                    <p className="text-lg text-gray-700 dark:text-neutral-400 leading-relaxed mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    <div className="flex flex-col justify-center">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-neutral-50 mb-4">Çeşitlilik, Eşitlik ve Kapsayıcılık</h2>
                        <p className="text-gray-700 dark:text-neutral-400 leading-relaxed">
                ...
                <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-lg p-8 md:p-12 mb-12 text-white">
                    ...
                    <p className="text-lg leading-relaxed mb-6 opacity-90">
                        Almanya İnternette Güvende (kısaca DsiN) ile deneyimli bir ortağımız var. Dijital eğitim projelerine katılıyoruz. Odak noktamız internet üzerinden güvenli ticaret yapmaktır.
                    </p>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    <div>
                        <img src="https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=800&q=80" alt="Nachbarschaftshilfe" className="w-full h-96 object-cover rounded-2xl shadow-lg dark:shadow-none" />
                    </div>
                    <div className="flex flex-col justify-center">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-neutral-50 mb-4">Komşu Yardımı</h2>
                        <p className="text-gray-700 dark:text-neutral-400 leading-relaxed mb-6">
                ...
                {/* PRO bono */}
                <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-lg dark:shadow-none p-8 md:p-12 mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-neutral-50 mb-6">ExVitrin PRO bono</h2>
