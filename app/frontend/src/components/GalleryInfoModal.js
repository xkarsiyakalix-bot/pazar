  ...
  const modal = (
    ...
    >
      ...
      >
        ...
        <div className="relative h-44 bg-gradient-to-br from-amber-50 via-gray-50 to-orange-50 dark:from-neutral-900 dark:via-neutral-950 dark:to-neutral-900 flex items-center justify-center overflow-hidden border-b border-gray-200 dark:border-white/10">
