        ...
        <div className="space-y-4 pt-4 border-t border-neutral-200 dark:border-white/10">
            ...
            {subCategory === 'Köpekler' && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-neutral-600 dark:text-neutral-400 mb-2 uppercase tracking-wider">{t.addListing.age || 'Yaş'}</label>
                        <select
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-neutral-600 dark:text-neutral-400 mb-2 uppercase tracking-wider">{t.addListing.pets.vaccinated}</label>
                        <select
                    ...
                    <div>
                        <label className="block text-sm font-semibold text-neutral-600 dark:text-neutral-400 mb-2 uppercase tracking-wider">{t.addListing.pets.permission}</label>
                        <select
