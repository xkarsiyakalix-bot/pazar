...
export const Footer = () => {
    return (
        <footer className="bg-gray-900 dark:bg-neutral-950 text-gray-300 dark:text-neutral-400 pt-12 pb-8 mt-16 transition-colors duration-300">
                ...
                <div className="flex flex-col md:grid md:grid-cols-3 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="hidden md:block">
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><a href="/cerez-politikasi" className="flex items-center gap-1.5 hover:text-white dark:hover:text-neutral-50 transition-colors group"><span className="brand-text group-hover:translate-x-0.5 transition-transform">›</span>Çerez Politikası</a></li>
                            <li><a href="/iletisim" className="flex items-center gap-1.5 brand-text hover:opacity-80 font-semibold transition-colors mt-2 group"><span className="group-hover:translate-x-0.5 transition-transform">›</span>{t.contact.title}</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="hidden md:block">
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><a href="/packages" className="flex items-center gap-1.5 hover:text-white dark:hover:text-neutral-50 transition-colors group"><span className="brand-text group-hover:translate-x-0.5 transition-transform">›</span>{t.footer.proPackages}</a></li>
                            <li><a href="#" className="flex items-center gap-1.5 hover:text-white dark:hover:text-neutral-50 transition-colors group"><span className="brand-text group-hover:translate-x-0.5 transition-transform">›</span>{t.footer.advertising}</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="flex flex-col items-center md:items-start gap-6">
                        ...
                        <div className="flex gap-4">
                            ...
                            {/* YouTube */}
                            <a href="https://www.youtube.com/@Exvitrin" target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-neutral-500 hover:text-white dark:hover:text-neutral-50 transition-colors" title="YouTube">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* TikTok */}
                            <a href="https://www.tiktok.com/@exvitrin" target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-neutral-500 hover:text-white dark:hover:text-neutral-50 transition-colors" title="TikTok">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* Pinterest */}
                            <a href="https://pinterest.com/exvitrin" target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-neutral-500 hover:text-white dark:hover:text-neutral-50 transition-colors" title="Pinterest">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* Threads */}
                            <a href="https://threads.net/@exvitrin" target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-neutral-500 hover:text-white dark:hover:text-neutral-50 transition-colors" title="Threads">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="border-t border-gray-800 dark:border-white/5 pt-8 text-center text-sm text-gray-500 dark:text-neutral-600 space-y-4">
