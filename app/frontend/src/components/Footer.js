                ...
                <div className="flex flex-col md:grid md:grid-cols-3 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="flex flex-col items-center md:items-start gap-6">
                        ...
                        <div className="flex gap-4">
                            ...
                            {/* YouTube */}
                            <a href="https://youtube.com/@exvitrin" target="_blank" rel="noopener noreferrer" className="text-gray-400 dark:text-neutral-500 hover:text-white dark:hover:text-neutral-50 transition-colors" title="YouTube">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
