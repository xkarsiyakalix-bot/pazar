#!/usr/bin/env python3
"""Script to create Dienstleistungen subcategory pages"""

subcategories = [
    {'name': 'Altenpflege', 'filename': 'DienstleistungenAltenpflegePage.js', 'route': 'altenpflege', 'icon': '''<circle cx="32" cy="26" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="32" cy="26" r="6" strokeWidth="2.5"/><path d="M22 38 L22 44 M42 38 L42 44" strokeWidth="2.5" strokeLinecap="round"/>''', 'description': 'Altenpflege Dienstleistungen'},
    {'name': 'Auto, Rad & Boot', 'filename': 'DienstleistungenAutoRadBootPage.js', 'route': 'auto-rad-boot', 'icon': '''<rect x="18" y="28" width="28" height="12" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/><rect x="18" y="28" width="28" height="12" strokeWidth="2.5" rx="2"/><circle cx="24" cy="42" r="2" fill="currentColor"/><circle cx="40" cy="42" r="2" fill="currentColor"/>''', 'description': 'Auto, Rad & Boot Services'},
    {'name': 'Babysitter/-in & Kinderbetreuung', 'filename': 'DienstleistungenBabysitterPage.js', 'route': 'babysitter-kinderbetreuung', 'icon': '''<circle cx="28" cy="26" r="4" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="28" cy="26" r="4" strokeWidth="2.5"/><circle cx="38" cy="30" r="3" strokeWidth="2" fill="none"/><path d="M24 32 L24 42 M32 32 L32 42" strokeWidth="2.5" strokeLinecap="round"/>''', 'description': 'Babysitter & Kinderbetreuung'},
    {'name': 'Elektronik', 'filename': 'DienstleistungenElektronikPage.js', 'route': 'elektronik', 'icon': '''<rect x="22" y="24" width="20" height="16" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/><rect x="22" y="24" width="20" height="16" strokeWidth="2.5" rx="2"/><circle cx="32" cy="32" r="3" fill="currentColor"/>''', 'description': 'Elektronik Reparatur & Service'},
    {'name': 'Haus & Garten', 'filename': 'DienstleistungenHausGartenPage.js', 'route': 'haus-garten', 'icon': '''<path d="M22 32 L32 22 L42 32 L42 44 L22 44 Z" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><path d="M22 32 L32 22 L42 32 L42 44 L22 44 Z" strokeWidth="2.5"/><rect x="28" y="36" width="8" height="8" strokeWidth="2" fill="none"/>''', 'description': 'Haus & Garten Services'},
    {'name': 'Künstler/-in & Musiker/-in', 'filename': 'DienstleistungenKuenstlerMusikerPage.js', 'route': 'kuenstler-musiker', 'icon': '''<circle cx="28" cy="28" r="6" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="28" cy="28" r="6" strokeWidth="2.5"/><path d="M36 24 L36 36 L40 38" strokeWidth="2.5" strokeLinecap="round"/>''', 'description': 'Künstler & Musiker Services'},
    {'name': 'Reise & Event', 'filename': 'DienstleistungenReiseEventPage.js', 'route': 'reise-event', 'icon': '''<rect x="22" y="26" width="20" height="14" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/><rect x="22" y="26" width="20" height="14" strokeWidth="2.5" rx="2"/><path d="M32 26 L32 22 M28 22 L36 22" strokeWidth="2" strokeLinecap="round"/>''', 'description': 'Reise & Event Services'},
    {'name': 'Tierbetreuung & Training', 'filename': 'DienstleistungenTierbetreuungPage.js', 'route': 'tierbetreuung-training', 'icon': '''<circle cx="28" cy="28" r="5" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="28" cy="28" r="5" strokeWidth="2.5"/><path d="M24 34 L24 42 M32 34 L32 42" strokeWidth="2.5" strokeLinecap="round"/><circle cx="38" cy="30" r="3" strokeWidth="2" fill="none"/>''', 'description': 'Tierbetreuung & Training'},
    {'name': 'Umzug & Transport', 'filename': 'DienstleistungenUmzugTransportPage.js', 'route': 'umzug-transport', 'icon': '''<rect x="18" y="26" width="28" height="14" strokeWidth="2.5" fill="currentColor" opacity="0.3" rx="2"/><rect x="18" y="26" width="28" height="14" strokeWidth="2.5" rx="2"/><circle cx="24" cy="42" r="2" fill="currentColor"/><circle cx="40" cy="42" r="2" fill="currentColor"/>''', 'description': 'Umzug & Transport'},
    {'name': 'Weitere Dienstleistungen', 'filename': 'DienstleistungenWeiterePage.js', 'route': 'weitere-dienstleistungen', 'icon': '''<circle cx="32" cy="32" r="10" strokeWidth="2.5" fill="currentColor" opacity="0.3"/><circle cx="32" cy="32" r="10" strokeWidth="2.5"/><path d="M28 30 L32 34 L36 30" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>''', 'description': 'Weitere Dienstleistungen'}
]
...
function {component_name}() {{
    ...
    const filteredListings = listings.filter(listing => listing.category === 'Dienstleistungen' && listing.subCategory === '{subcategory_name}');
...
print(f"\n✅ Created {len(subcategories)} Dienstleistungen subcategory pages!")
